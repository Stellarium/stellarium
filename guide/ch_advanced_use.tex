...
but an extended DSO catalog with over one million objects (up to $20.0^m$) may be downloaded
from Stellarium's SourceForge website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.6}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.6; extended edition & \file{catalog.dat} &\texttt{2341a8aab8992a8e45fe9844d4ea3855}& 28.2\,MB\\\bottomrule
\end{tabular}
