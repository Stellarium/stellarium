...
% The User Guide uses biber for its bibliography and makeindex for its index.
% Compile it from the command line with the 
% commands below to make sure your LaTeX distribution is configured correctly:
%
% 1) pdflatex guide
% 2) makeindex guide.idx -s indexstyle.ist
% 3) biber guide
...
%
% This document also uses a number of packages which may need to be
...
% --------------------------------------------------------------------------------------
% GZ: Stack pdf hypersetup
% https://tex.stackexchange.com/questions/662094/can-i-call-hypersetup-twice
% May need LaTeX from 2022...
% --------------------------------------------------------------------------------------
% \DocumentMetadata{} 
...
%----------------------------------------------------------------------------------------
% See https://tex.stackexchange.com/questions/581907/extra-endgroup-error
%\RequirePackage[2020-02-02]{latexrelease}
\ifhtlatex
\documentclass[11pt,fleqn,dvipdfmx]{LegrandOrangeBook} % Default font size and left-justified equations
\else
...
\documentclass[11pt,fleqn,dvipdfmx,a4paper]{LegrandOrangeBook} % Default font size and left-justified equations
\else
...
\input{structure} % Insert the structure.tex file which contains the majority of the structure that came with the original template and extends it
\input{version} % Insert Stellarium version information. This file must be created anew for each version!
...
\renewcommand{\StelTOCdepth}{1}
\part{Extending Stellarium}
%\chapterimage{chapter-t3-bg.png} % Chapter heading image
\include{ch_plugins}
\include{plg_interfaces} % TUI, RemoteControl, RemoteSync, (2024: D-BUS?)
\include{plg_calendars} % move to historical?
\include{plg_catalogs}
\include{plg_archaeolines} % move to historical?
