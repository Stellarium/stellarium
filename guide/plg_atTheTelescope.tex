...
\item[RTS2 Telescope] is the INDIRECT case
...
your user must have telescope in allowed devices. Please see \texttt{man
rts2-user} for details on how to manipulate RTS2 users.

\begin{description}
\item[URL] points to RTS2 HTTPD. Can include anything URL can have - port
...
is beyond scope of this handbook. Please refer to the RTS2 Web pages (
\url{http://rts2.org/}) for details.
