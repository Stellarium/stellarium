...
You can edit \file{config.ini} file to change the
...
"Star designation":
{
   ...
   },
   {
      ...
      "pclass": "planetary class",
      "EqTemp": equilibrium temperature (K),
      "conservative": conservative or optimistic habitability of the 
                      exoplanet,
      "ESI": Earth Similarity Index (*100),
      "planetProperName": "proper name of planet",
      "planetName": "designation of planet"
...
To add a new quasar, open a new line after line 5 and create a new section. 
For example, the record for \textbf{3C 249.1} looks like (note commas and brackets -- 
they are important!):


\begin{configfile}
"3C 249.1":                  // Quasar designation
{
    "RA": "11h04m13.8s",     // Right ascension (J2000)
    "DE": "+76d58m58s",      // Declination (J2000)
    "Amag": -25.1,           // value of absolute magnitude
    "Vmag": 15.72,           // value of visual magnitude
    "z": 0.313,              // value of Z (redshift)
    "bV": -0.02              // value of B-V colour
},
\end{configfile}
...
For example, below is a record for the \textit{Northern Taurids}:
...
the unaided eye. 
Satellites which are\newFeature{25.4} reported to transit the penumbra (twilight) zone are rendered with a subdued color. 
...
\begin{figure}[t]
	\centering\includegraphics[width=0.57\textwidth]{satellites_plugin_filters.jpg}
...
\begin{figure}[tb]
	\centering\includegraphics[width=0.57\textwidth]{satellites_plugin_comms.jpg}
