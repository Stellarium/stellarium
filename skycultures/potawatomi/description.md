...
The date attached to the map is a technical and interpretive choice made to accommodate the requirements of the map feature. This is a living body of traditional knowledge with origins that predate written records and that continues to the present day. Although seventeenth-century Jesuit records document some of our ancestral constellations, using the date of those records as the beginning of the sky culture would be inaccurate and misleading. We encourage users to do their own reading and research on Potawatomi history and culture.
