...
%% TODO The names of all available StelProperties can be found ... 
%% <Maybe a scripting function is missing which calls StelPropertyMgr::getAllProperties() and dumps a map to output.txt?>
