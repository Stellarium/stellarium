...
\item An additional settings for the information display
\end{itemize}
...
\item[Show bookmarks button] You can disable display of Bookmarks dialog with this button.
...
\item[Azimuth from South] Some users may be used to counting azimuth
  from south.
\item[Use buttons background] Some users may be want to disable usage of background under buttons on bottom bar.
...
\item[Show constellation boundaries button] You can toggle display of boundary of the constellations with this button.
\item[Use decimal degrees] You can toggle usage decimal format for coordinates by this checkbox.
...
\item[Indication for mount mode] You can toggle usage indication for type of used mount by this checkbox.
\end{description}

\noindent In addition, you can set the directory where screenshots will be stored, and you can download more star catalogs on this tab.
...
\item[Show ray helpers\ldots] Activate display of special navigational lines who make connection different stars (like the shortcut \keys{Alt+R}) and you can configure thickness of those lines here.\newFeature{v0.17.0}
...
Double-clicking on an entry brings the object into focus (Figure~\ref{fig:gui:AstroCalc:Positions}). You may save the list of position into CSV file also.


\begin{figure}[htbp]
\centering\includegraphics[width=0.60\textwidth]{astrocalc_dialog_positions_tab}
...
\begin{figure}[tbp]
\centering\includegraphics[width=0.98\textwidth]{astrocalc_dialog_ephemeris_tab}
...
\begin{figure}[tbp]
\centering\includegraphics[width=0.98\textwidth]{astrocalc_dialog_ephemeris_analemma}
\caption{Astronomical Calculations (AstroCalc): Analemma on the Earth}
\label{fig:gui:AstroCalc:Ephemeris:Analemma}
\end{figure}

\begin{figure}[tbp]
\centering\includegraphics[width=0.98\textwidth]{astrocalc_dialog_ephemeris_analemma_mars}
...
The ``Planetary Calculator'' (PC) tool\newFeature{v0.17.0} has been added by users requests and it computes the relations between two Solar system bodies for the current date and location --- linear and angular distances, orbital resonances and orbital velocities.

\begin{figure}[htbp]
\centering\includegraphics[width=0.75\textwidth]{astrocalc_dialog_pc_tab}
