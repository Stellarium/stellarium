...
This tab in version 0.18.3 \newFeature{v0.18.3} provides graph, who helpful for monthly observation planning of deep-sky objects. Since version 0.19.0 this tab provides sub-tabs with graphs helpful for observation planning and analyze of changes between objects or changes for their positions.
