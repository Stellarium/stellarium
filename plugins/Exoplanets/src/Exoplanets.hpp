...
public:	
	...
	virtual QString getName() const override { return "Exoplanets"; }
	virtual QString getStelObjectType() const override { return Exoplanet::EXOPLANET_TYPE; }
