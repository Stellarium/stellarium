...
{\begin{tikzpicture}[remember picture,overlay]
\node[anchor=north west,inner sep=0pt] at (0,0) {\includegraphics[width=\paperwidth]{bookcover_cygnus}}; % Background image
\draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]%
     {\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}%
                                              ...
                                              {\Large Georg Zotti, Alexander Wolf, Matthew Gates, Barry Gerdes}\\[15pt]% Author names
                                              {\Large 2017}% Year
                                             }}; % 
\end{tikzpicture}};
\end{tikzpicture}
...
\noindent Copyright \copyright\ 2014-2017 Georg Zotti.\\ % Copyright notice
\noindent Copyright \copyright\ 2011-2017 Alexander Wolf.\\ % Copyright notice
...
%----------------------------------------------------------------------------------------
%	CHAPTER G (Acknowledgements) 
%----------------------------------------------------------------------------------------

\include{app_acknowledgements}

%----------------------------------------------------------------------------------------
%	CHAPTER H (License) -- N.B. "G" for GNU sounds also good.
%----------------------------------------------------------------------------------------
