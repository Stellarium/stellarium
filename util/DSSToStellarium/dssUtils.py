...
class DssWcs:
  ...
  def __init__(self, plateName):
    ...
    try:
      ...
      for el in offsets:
        ...
        self.inverseGridPixelPos.append([el['pixelPos'][0]+el['offset'][0], el['pixelPos'][1]+el['offset'][1]])
  ...
  def pixelToRaDec(self, pixelPos):
    ...
    if self.inverseGridPixelPos!=None:
      nearestOffset = scipy.interpolate.griddata(self.inverseGridPixelPos, self.gridOffset, [arr], method='nearest')
