...
an object's position when the Sun is at a specific altitude relative to the horizon (only values $\le 0^\circ$ are valid).
The value can be changed in the \guibutton[0.6]{0.1}{uibtSettings.png}~\emph{Extra options} window (Fig.~\ref{fig:gui:AstroCalc:Ephemeris:SunAtAltitude}).
