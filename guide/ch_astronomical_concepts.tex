...
Occasionally, instrument makers of the past may have engraved polar distance $p$ instead: $p=90^\circ-\delta$. 
Stellarium \newFeature{25.4} can be configured to use this convention, see section~\ref{sec:gui:configuration:extras}.
...
the field of view. We can describe the \indexterm[Coordinate
  ...
  towards the west (6h) and is aptly named \indexterm{Hour
...
\item[Astronomical Ephemeris (1960).] This is a slightly modified
  ...
  the \citetp{Mucke-Meeus:Solar:1983}. Valid range of usage: between years
...
\item[JPL Horizons.] The JPL Solar System Dynamics Group of the NASA\newFeature{26.1}
  Jet Propulsion Laboratory has developed an interactive
  application JPL HORIZONS\footnote{\url{https://ssd.jpl.nasa.gov/?horizons}} which provides
  $\Delta T=TDB-UT$ between -9998 and 1962 and $\Delta T=TDB-UTC$ between 1962 to 9999
...
\item[Espenak \& Meeus (2006, 2014).] This solution by F. Espenak and J. Meeus, based on 
  ...
  , in their \citetp{Espenak-Meeus:2006} and \citetp{Espenak:2014}. This formula is also used in the
...
includes\newFeature{25.1} the apparent shift in position of star due to annual parallax.
...
motion around each other, where known,\newFeature{25.1} is now properly modelled in Stellarium. 
