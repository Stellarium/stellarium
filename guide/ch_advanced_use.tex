...
from Stellarium's SourceForge website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.5}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.5; extended edition & \file{catalog.dat} &\texttt{b11890691ea4a2047b55e286910fb2e9}& 28.1\,MB\\\bottomrule
\end{tabular}
