...
```
sudo yum install cmake gcc graphviz doxygen gettext git qtbase5-devel qt5-qttools-devel qt5-qtscript-devel qt5-qtmultimedia-devel qt5-qtserialport-devel qt5-qtlocation-devel qt5-qtpositioning-devel
```
