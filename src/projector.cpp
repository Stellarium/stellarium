...
bool Projector::check_in_screen(Vec3d& pos)
{
...
bool Projector::project_earth_equ(const Vec3f& v, Vec3d& win)
{
    return project_custom(v, win, mat_earth_equ_to_eye);
}
bool Projector::project_earth_equ(const Vec3d& v, Vec3d& win)
{
    return project_custom(v, win, mat_earth_equ_to_eye);
}
bool Projector::project_earth_equ_check(const Vec3f& v, Vec3d& win)
{
    return project_custom_check(v, win, mat_earth_equ_to_eye);
}
bool Projector::unproject_earth_equ(double x ,double y, Vec3d& v)
{
	return unproject_custom(x ,y, v, mat_earth_equ_to_eye);
}


bool Projector::project_helio(const Vec3f& v, Vec3d& win)
{
    return project_custom(v, win, mat_helio_to_eye);
}
bool Projector::project_helio_check(const Vec3f& v, Vec3d& win)
{
	return project_custom_check(v, win, mat_helio_to_eye);
}
bool Projector::unproject_helio(double x ,double y, Vec3d& v)
{
	return unproject_custom(x ,y, v, mat_helio_to_eye);
}


bool Projector::project_local(const Vec3f& v, Vec3d& win)
{
    return project_custom(v, win, mat_local_to_eye);
}
bool Projector::project_local(const Vec3d& v, Vec3d& win)
{
    return project_custom(v, win, mat_local_to_eye);
}
bool Projector::project_local_check(const Vec3f& v, Vec3d& win)
{
    return project_custom_check(v, win, mat_local_to_eye);
}
bool Projector::unproject_local(double x ,double y, Vec3d& v)
{
	return unproject_custom(x ,y, v, mat_local_to_eye);
}


bool Projector::project_custom(const Vec3f& v, Vec3d& win, const Mat4d& mat)
{
    gluProject(v[0],v[1],v[2],mat,mat_projection,vec_viewport,&win[0],&win[1],&win[2]);
	return (win[2]<1.);
}
bool Projector::project_custom(const Vec3d& v, Vec3d& win, const Mat4d& mat)
{
    gluProject(v[0],v[1],v[2],mat,mat_projection,vec_viewport,&win[0],&win[1],&win[2]);
	return (win[2]<1.);
}
bool Projector::project_custom_check(const Vec3f& v, Vec3d& win, const Mat4d& mat)
{
    gluProject(v[0],v[1],v[2],mat,mat_projection,vec_viewport,&win[0],&win[1],&win[2]);
	return (win[2]<1. && check_in_screen(win));
}
bool Projector::unproject_custom(double x ,double y, Vec3d& v, const Mat4d& mat)
{
...
void Projector::set_orthographic_projection(void)
{
...
void Projector::reset_perspective_projection(void)
{
