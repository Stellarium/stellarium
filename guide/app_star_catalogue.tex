...
In version 0.20.4\newFeature{v0.20.4} we incorporated support an additional designations 
for \indexterm{double stars} which have HIP identification also. All these designations 
was added especially for double stars observers and people, who using Stellarium as some 
reference software. The cross-identification data for double stars was obtained 
from \emph{The Cambridge Double Star Atlas}~\citep{2015cdsa.book.....M}.
