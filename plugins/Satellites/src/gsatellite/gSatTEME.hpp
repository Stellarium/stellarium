...
**		 This class abstract all the SGP4 complexity. It uses the revised David. A. Vallado
**		 code for SGP4 Calculation.
**
** Reference:
...
#ifndef GSATTEME_HPP_
#define GSATTEME_HPP_ 1
...
public:
	...
	//!    y: position[1]
	//!    z: position[2]
	gVector getPos(){ return m_Position;}
	...
	int getErrorCode(){return satrec.error;}
