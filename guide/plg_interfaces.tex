...
\else
\includegraphics[width=.3\textwidth]{GZ_analemma_p1000.png}
\includegraphics[width=.3\textwidth]{GZ_analemma_p2000.png}
\fi
...
flag\_show\_constellation  & bool    & Add the 3-letter IAU\index{IAU} abbreviation for the constellation the 
                                       mouse pointer sits in \cite{1987PASP...99..695R}.\\\midrule
