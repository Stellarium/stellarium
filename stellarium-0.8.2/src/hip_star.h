...
///    int ChartColorIndex;
  ...
  static bool apply_degamma; // Kornyakov: flag for degamma
  static bool hyper_stars;   // Kornyakov: flag for hyper stars
  static float evenness_coeff;
  static float star_max_radius;
};
