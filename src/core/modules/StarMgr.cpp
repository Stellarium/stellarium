...
static const int StarCatalogFormatVersion = 9;
...
void StarMgr::init()
{
	...
	texPointer = StelApp::getInstance().getTextureManager().createTexture(StelFileMgr::findFile("textures/pointeur2.png")); // Load pointer texture
