...
Stellarium uses levels 0 to 8 in the existing star catalogues. Star Data
Records contain the encoded position of a star.
...
\begin{description}
\item[\file{stars\_0\_0v0\_12.cat}]
\item[\file{stars\_1\_0v0\_12.cat}]
\item[\file{stars\_2\_0v0\_12.cat}]
\item[\file{stars\_3\_0v0\_7.cat}]
\item[\file{stars\_4\_1v0\_4.cat}]
\item[\file{stars\_5\_1v0\_4.cat}]
\item[\file{stars\_6\_1v0\_3.cat}]
...
\begin{description}
\item[\file{object\_types\_v0_1.cat}]
...
The files \file{stars\_hip\_sp\_0v0\_6.cat} contain spectral type of HIP stars. 
The files \file{object\_types\_v0\_1.cat} contain object type classification name for the main star catalogs. The
...
\midrule
\file{stars\_0\_0v0\_12.cat} & 0 & 48 bytes & 0 &        5,027 & Hipparcos + Gaia\\
\file{stars\_1\_0v0\_12.cat} & 0 & 48 bytes & 1 &       21,421 & Hipparcos + Gaia\\
\file{stars\_2\_0v0\_12.cat} & 0 & 48 bytes & 2 &      141,558 & Hipparcos + Gaia\\
\file{stars\_3\_0v0\_7.cat} & 0 & 48 bytes & 3 &      418,209 & Gaia\\
\file{stars\_4\_1v0\_4.cat} & 1 & 32 bytes & 4 &    1,741,890 & Gaia\\
\file{stars\_5\_1v0\_4.cat} & 1 & 32 bytes & 5 &    8,051,915 & Gaia\\
...
Details about vector algebra related to astrometric calculations can be found in \citep{2012asas.book.....V}

\begin{table}[p]
\begin{tabular}{llllp{55mm}}\toprule
\emph{Name} & \emph{Offset} & \emph{Type} & \emph{Size} &\emph{Description}\\\midrule
gaia_id        &  0 & long long          & 8 & Gaia source id\\%\midrule
...
plx_err        & 38 & unsigned short     & 2 & parallax error of the star in 0.01 mas unit.\\
...
obtype		   & 44 & unsigned char      & 1 & object type classification index. The index corresponds to the line number in the file \file{object\_types_v*.cat} - 1.\\
...
\emph{Name} & \emph{Offset}& \emph{Type} & \emph{Size} &\emph{Description}\\\midrule
gaia_id        &  0 & long long          & 8 & Gaia source id\\%\midrule
x0             &  8 & int                & 4 & RA of the star in mas unit.\\%\midrule
x1             & 12 & int                & 4 & DEC of the star in mas unit.\\%\midrule
dx0            & 16 & int                & 4 & Proper motion in RA of the star in $mu$as/year (without $\cos{\mathrm{DEC}}$)%\midrule
dx1            & 20 & int                & 4 & Proper motion in DEC of the star in $mu$as/year%\midrule
...
plx_err        & 30 & unsigned short     & 2 & parallax error of the star in 0.01 mas unit.\\
\end{tabularx}
...
\emph{Name} & \emph{Offset} & \emph{Type} & \emph{Size} & \emph{Description}\\\midrule
gaia_id        &  0 & long long          & 8 & Gaia source id\\%\midrule
x0             &  8 & int                & 3 & RA of the star in 0.1 arcsecond unit.\\%\midrule
x1             & 11 & int                & 3 & DEC of the star in 0.1 arcsecond unit.\\%\midrule
b\_v           & 14 & unsigned short     & 1 & $B-V$ colour in 25 milli-mag unit offset by $+1$ mag.
mag            & 15 & unsigned short     & 1 & $V$-band magnitude in 20 milli-mag unit offset by $-16$ mag.
\end{tabularx}
