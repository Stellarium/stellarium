...
provided.  When a file named \file{asteroid\_ephemeris.json} is present
...
\subsubsection{Generating the ephemeris file}
\label{sec:ssystem.ini:MultiEpoch:Script}
 
A Python script, \file{fetch\_asteroid\_ephemeris.py}, is provided in
...
\begin{commands}
python3 fetch_asteroid_ephemeris.py
\end{commands}
...
\begin{commands}
python3 fetch_asteroid_ephemeris.py --start-at 247
\end{commands}
...
\item[\texttt{--out} \textit{FILE}] Output filename.  Default:
  \texttt{asteroid\_ephemeris.json}.
