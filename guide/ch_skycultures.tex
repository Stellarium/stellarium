...
You can take the \file{inuit} directory as example. Just copy the folder 
...
certain abbreviations from being displayed, let the start with a
...
skyculture, please use the canonical Latin names.
...
File \file{seasonal\_rules.fab} (optional) contains seasonal rules for
...
If you are willing to let other users enjoy your hard work (and we
