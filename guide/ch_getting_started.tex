...
You can also download and run our \emph{AppImage} package for 64-bit linuxes (we do not
provide an \emph{AppImage} for old 32-bit systems):
...
Similar to an \emph{AppImage} packages you may use \emph{flat}\footnote{\url{https://flathub.org/apps/details/org.stellarium.Stellarium}} and \emph{snap}\footnote{\url{https://https://snapcraft.io/stellarium-daily}} packages also.
