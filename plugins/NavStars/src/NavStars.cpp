...
void NavStars::displayTabulatedInfo(const StelObjectP& selectedObject, NavStarsCalculator& calc, const QString& extraText)
{
	...
	selectedObject->addToExtraInfoString(infoGroup, QString("<table style='margin:0em 0em 0em -0.125em;border-spacing:0px;border:0px;color:%1;'>").arg((selectedObject->getInfoColor()).toHtmlColor()));
	selectedObject->addToExtraInfoString(infoGroup, 
