...
QString StelCore::getCurrentDeltaTAlgorithmDescription(void) const
{
	...
	switch (getCurrentDeltaTAlgorithm())
	{
		...
		case EspenakMeeus: // GENERAL SOLUTION
			description = q_("This solution is modified from the solution by F. Espenak and J. Meeus, based on Morrison & Stephenson (2004) and a polynomial fit through tabulated values for 1600-2000, is used for the %1NASA Eclipse Web Site%2 and in their <em>Five Millennium Canon of Solar Eclipses: -1900 to +3000</em> (2006). This formula is also used in the solar, lunar and planetary ephemeris program SOLEX. Formula for 2005-2050 is modified to match observed values and near-term predictions.").arg("<a href='http://eclipse.gsfc.nasa.gov/eclipse.html'>").arg("</a>").append(getCurrentDeltaTAlgorithmValidRangeDescription(jd, &marker)).append(" <em>").append(q_("Used by default.")).append("</em>");
			break;
