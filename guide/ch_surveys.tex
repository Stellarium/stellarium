...
\url{http://alaskybis.unistra.fr/hipslist}\footnote{Since version 0.20.3 the first URL was changed to \url{http://alasky.u-strasbg.fr/MocServer/query?*/P/*&get=record} due changes in HiPS service} and
