...
public:
	...
	virtual QString getName() const override { return "Pulsars"; }
	virtual QString getStelObjectType() const override { return Pulsar::PULSAR_TYPE; }
