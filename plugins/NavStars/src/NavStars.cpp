...
void NavStars::populateNavigationalStarsSet(void)
{
	...
	switch(getCurrentNavigationalStarsSet())
	{
		case AngloAmerican:
		{
			...
			starNumbers = {
					   677,   2081,   3179,   3419,   7588,   9884,  13847,
		...
		case French:
		{
			...
			starNumbers = {
					   677,    746,   1067,   2081,   3179,   3419,   4427,
		...
		case Russian:
		{
			...
			starNumbers = {
					   677,    746,   1067,   2021,   2081,   3179,   3419,
		...
		case MeadeLX200:
		{
			...
			// HIP 28380 = Bogardus
			starNumbers = {
					  7588,  60718,  95947,  67301,  21421,  26311,
		...
		case MeadeETX:
		{
			...
			starNumbers = {
					 69673,  49669,  65474,  91262, 102098,  97649,  80763,
		...
		case MeadeAS494:
		{
			...
			starNumbers = {
					 13847,   7588,  60718,  33579,  95947,  65477,  17702,
		...
		case Celestron:
		{
			...
			starNumbers = {
					 32349,  30438,  69673,  91262,  24608,  24436,  37279,
		...
		case Apollo:
		{
			...
			starNumbers = {
					   677,   3419,   4427,   7588,  11767,  13847,  13954,
		...
		case Skywatcher:
		{
			...
			starNumbers  = { 
					 13847,  33579,  95947,  67301,  17702,  21421, 105199,
