...
In this mode, the circle marks are not linked with the sky, but with the horizontal coordinate system.
For example, you can get an analemma of the Sun for any location (Figure~\ref{fig:gui:AstroCalc:Ephemeris:Analemma}), 
or observe the visibility of Mercury or Venus in the twilight sky.
