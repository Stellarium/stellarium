...
public:
   ...
   inline int    getMag() const { return qFromLittleEndian<qint16>(d.vmag); } // in milli-mag
   inline int    getSpInt() const { return qFromLittleEndian<quint16>(d.spInt); }
   inline double getX0() const { return qFromLittleEndian<qint32>(d.x0) / 2.e9; }
   inline double getX1() const { return qFromLittleEndian<qint32>(d.x1) / 2.e9; }
   inline double getX2() const { return qFromLittleEndian<qint32>(d.x2) / 2.e9; }
   inline double getDx0() const { return qFromLittleEndian<qint32>(d.dx0) / 1000.; }
   inline double getDx1() const { return qFromLittleEndian<qint32>(d.dx1) / 1000.; }
   inline double getDx2() const { return qFromLittleEndian<qint32>(d.dx2) / 1000.; }
   inline double getPlx() const { return qFromLittleEndian<quint16>(d.plx) * 0.02; }
   inline double getPlxErr() const { return qFromLittleEndian<quint16>(d.plx_err) / 100.; }
   inline double getPMTotal() const
   {
   ...
   inline double getRV() const { return qFromLittleEndian<qint16>(d.rv) / 10.; }
   inline bool   getPreciseAstrometricFlag() const
   {
   ...
   inline StarId  getGaia() const { return qFromLittleEndian<quint64>(d.gaia_id); }
   ...
   inline int getObjType() const { return qFromLittleEndian<quint8>(d.objtype); }
   float      getBV(void) const { return static_cast<float>(qFromLittleEndian<qint16>(d.b_v)) / 1000.f; }
...
public:
   inline double getX0() const { return qFromLittleEndian<qint32>(d.x0) * MAS2RAD; }
   inline double getX1() const { return qFromLittleEndian<qint32>(d.x1) * MAS2RAD; }
   ...
   StarId         getGaia() const { return qFromLittleEndian<qint64>(d.gaia_id); }
   float          getBV(void) const { return static_cast<float>(qFromLittleEndian<qint16>(d.b_v)) / 1000.f; }
   ...
   double         getPlx() const { return qFromLittleEndian<quint16>(d.plx) / 100.; }
   double         getPlxErr() const { return qFromLittleEndian<quint16>(d.plx_err) / 100.; }
...
public:
   ...
   inline double getX0() const
   {
      ...
      return static_cast<double>(qFromLittleEndian<quint32>(x0)) * 100. * MAS2RAD;
   }
   inline double getX1() const
   {
      quint32 x1 = d.x1[0] | (d.x1[1] << 8) | (d.x1[2] << 16);
      return (static_cast<double>(qFromLittleEndian<quint32>(x1)) - (90. * 36000.)) * 100. * MAS2RAD;
   }
   inline double  getX2() const { return 0.; }
   ...
   double         getRV() const { return 0.; }
   double         getBV() const { return (0.025 * qFromLittleEndian<quint8>(d.b_v)) - 1.; } // in mag
   double         getMag() const { return qFromLittleEndian<quint8>(d.vmag) * 20 + 16000; } // in milli-mag
   StarId         getHip() const { return 0; }
   StarId         getGaia() const { return qFromLittleEndian<qint64>(d.gaia_id); }
