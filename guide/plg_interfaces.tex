...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item For images solved via Astrometry.net, if manual coordinate adjustments deviate too much, a reset button (anticlockwise open circle arrow icon) will appear above \guibutton{0.6}{uibtProcess.png}. Clicking this will reset the coordinates back to the original astrometric solution.
