/*
 * Thanks to isee15, this file is developed with the help of: https://github.com/isee15/Lunar-Solar-Calendar-Converter/tree/master/C:C%2B%2B
 */
...
ChineseCalendar getChineseCalendarFromGregorian(Gregorian g)
{
	...
	int days = chineseMonthDays[index];
	...
	lunarD = (int) (offset);
	chineseCalendar.year = lunarY;
	chineseCalendar.month = lunarM;
	chineseCalendar.isleap = false;
	if (leap != 0 && lunarM > leap)
	{
		chineseCalendar.month = lunarM - 1;
		if (lunarM == leap + 1)
		{
			chineseCalendar.isleap = true;
		}
	}

	chineseCalendar.day = lunarD;
