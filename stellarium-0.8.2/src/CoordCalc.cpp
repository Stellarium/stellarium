...
{ 
	...
	StraightCoordCalc::StraightCoordCalc(const Vec3d& s, double d, double startTime) : start(s), delta(d), mStartTime(startTime)
	{
	}
	...
	{		
		...
		double q = 1.0 - 4.0 / cPi * atan((t - mStartTime) / mDur);
		return q * mStart;
	}
