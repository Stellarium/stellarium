...
curl -d 'id=LandscapeMgr.fogDisplayed&value=false' http://localhost:8090/api/stelproperty/set 
\end{commands}
...
\begin{commands}[\scriptsize]
curl -G -d 'id=propId=-1&actionId=-2' http://localhost:8090/api/main/status | python -m json.tool 
\end{commands} 
