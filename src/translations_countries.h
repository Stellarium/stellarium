...
class GeoLocTranslations
{
	void GeoLocTranslations(){;}

	static translationGeoLoc()
	{
		...
		N_("Greece");
		// TRANSLATORS: https://en.wikipedia.org/wiki/South_Georgia_&_South_Sandwich_Islands
