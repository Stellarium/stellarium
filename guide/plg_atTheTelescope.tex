...
Some users are running Stellarium on a little, low-power ``Telescope computer'' connected to 
their powerful indoor PCs vie RemoteDesktop or similar setups. Keep in mind that Stellarium 
is a graphical program that may challenge the outdoor computer's graphics subsystem or network.
See fps intent settings on page~\pageref{sec:gui:configuration:tools:fps} for optimizing your screen refresh rates. 
