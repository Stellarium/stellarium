...
\begin{enumerate}
\item \menu{File>Import>Wavefront .obj} - you may need to change the forward/up axes for correct orientation, try -Y for forward and Z for up
...
and altitude. The secton is required if \verb|coord/convergence_angle=from_grid|, else
...
Verify the new model loads correctly, e.g.\ in \program{Meshlab}\footnote{\url{www.meshlab.org}}!
