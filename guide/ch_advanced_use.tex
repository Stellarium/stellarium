...
from Stellarium's Github website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.10}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.10; extended edition & \file{catalog.dat} &\texttt{cf49d0d5d450c265da848c1d0fef99a2}& 27MB\\\bottomrule
\end{tabular}
