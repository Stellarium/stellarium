...
Stellarium's DSO Catalog contains over 83000 objects\footnote{The extended edition of this catalog with over one million objects may be downloaded and installed by hands (see section \ref{sec:ExtraData:DSOs}).} (up to $15.5^m$) and is available for end users as collection of files:
