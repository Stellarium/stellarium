...
public:
	...
	//! - modern-elongation (elongation in ecliptic longitude or Δλ; on Earth only; radians)
	//! - modern-elongation-dms (elongation in ecliptic longitude or Δλ; on Earth only; formatted string; DMS)
	//! - modern-elongation-deg (elongation in ecliptic longitude or Δλ; on Earth only; formatted string; degrees)
