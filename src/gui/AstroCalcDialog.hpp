...
private:
	...
	enum WUTCategory {
		...
		planetary_nebulae,
		bright_double_stars,
		bright_variable_stars,
		bright_stars_with_high_proper_motion,
		Algol_types,	// http://www.sai.msu.su/gcvs/gcvs/vartype.htm
		symbiotic_stars,
		emission_line_stars,
		supernovae_candidates,
		supernovae_remnant_candidates,
		supernovae_remnants,
		clusters_of_galaxies,
		interstellar_objects,
		globular_star_clusters,
		regions_of_the_sky,
		active_galaxies,
		pulsars,
		exoplanetary_systems,
		bright_nova_stars,
		bright_supernova_stars,
		interacting_galaxies,
		deep_sky_objects,
		Messier_objects,
		NGC_IC_objects,
		Caldwell_objects,
		Herschel_400_objects,

		none	// stop gapper for syntax reasons
	};
};
