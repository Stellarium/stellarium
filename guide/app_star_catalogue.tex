...
In version 0.20.4\newFeature{v0.20.4} we incorporated support an additional designations for \indexterm{double stars} which have HIP identification also. All these designations was added especially for double stars observers and people, who using Stellarium as some reference software. The cross-identification data for double stars was obtained from \empth{The Cambridge Double Star Atlas}~\citep{2015cdsa.book.....M}.

\begin{longtable}{l|l|p{105mm}}\toprule
\emph{Designation} & \emph{WDS code} & \emph{Discoverer/catalog/observatory}\\\midrule
$\beta$   		& BU  & S.W. Burnham \\
$\beta$ pm 		& BUP & Burnham's 1913 proper motion catalog \\
$\Delta$		& DUN & J. Dunlop \\
$\Sigma$        & STF & F.G. Wilhelm Struve's 1827 Dorpat catalog \\
$\Sigma$ I 		& --- & Wilhelm Struve's first supplement to Dorpat catalog \\
$\Sigma$ II		& --- & Wilhelm Struve's second supplement to Dorpat catalog \\
$\phi$		    & FIN & W.S. Finsen \\
A		        & A   & R.G. Aitken \\
AC		        & AC  & Alvan Clark \\
...
O$\Sigma$       & STT & Otto Struve's 1843 Pulkovo catalog \\
O$\Sigma\Sigma$ & STT & Otto Struve's 1843 Pulkovo catalog supplement \\
Pz  	        & PZ  & G. Piazzi \\
R   	        & R   & H.C. Russell \\
...
WNO  	        & WNO & US Naval Observatory (USA) \\\bottomrule
\caption{Additional designations to double stars}
