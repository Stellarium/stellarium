...
for inner planets and quadratures for outer planets in additional to exist phenomena.
...
This subtab \newFeature{v0.18.3} can show ``Lunar Distance'' (``Angular Distance'' previously) graph --- change of angular distance between the Moon and selected object (for example some deep-sky object) for the nearest 30 days. This tool was introduced for planning monthly observations (Fig.~\ref{fig:gui:AstroCalc:Graphs:LD}).
