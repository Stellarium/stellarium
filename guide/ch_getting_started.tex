...
Or download and run our AppImage package for 64-bit linuxes (we do not provide an AppImage for old 32-bit systems): \file{Stellarium-\StelVersion-x86\_64.AppImage}. To avoid possible conflicts due architectural features of AppImage please remove stellarium package, where you installed from repository.
