...
\begin{figure}[p]
	\centering\includegraphics[width=0.75\textwidth]{astrocalc_dialog_ephemeris_sun_at_altitude.png}
...
\begin{figure}[p]
	\centering\includegraphics[width=0.75\textwidth]{astrocalc_dialog_ephemeris_planet_opposition.png}
...
Two time steps \newFeature{26.2} require a bit of care to display well. The \emph{Sun at altitude} displays
an object's position when the Sun is at a specific altitude relative to the horizon (only values ≤ 0° are valid).
The value can be changed in the \emph{Extra options} window (Fig.~\ref{fig:gui:AstroCalc:Ephemeris:SunAtAltitude}).
Using it as intented requires the ephemeris to be drawn in horizontal coordinates!

The other time step that requires some care is the \emph{Planet at opposition}. This is useful for displaying where
and when a planet will be at its opposition for a given year in relation to background stars. For it to make sense, 
the planet in question needs to be selected both in the ephemeris list and in the \emph{Extra options} window 
(under the title "Opposition of planet", Fig.~\ref{fig:gui:AstroCalc:Ephemeris:PlanetOpposition}).
