...
% \usepackage{color} %% DO WE REALLY NEED IT?
\usepackage{listings}
...
%% Part text styling ==> GZ: changed in class. 
%% GZ: Reactivate these (or redefine from the new definitions in the cls file) to keep old definition in SUG?
