...
public:
	...
	/** Set flag for applying degamma */
	void setFlagApplyDegamma(bool b) {applyDegamma=b;}
	/** Set flag for applying degamma */
	bool getFlagApplyDegamma(void) const {return applyDegamma;}	
	
	/** Set flag for hyper stars */
	void setFlagHyperStars(bool b) {hyperStars=b;}
	/** Set flag for Hyper Stars*/
	bool getFlagHyperStars(void) const {return hyperStars;}
	...
	void setStarMaxRadius(float b) {starMaxRadius=b;}
	/** Set stars maximum radius */
	float getStarMaxRadius(void) const {return starMaxRadius;}
...
private:
	...
	bool applyDegamma; // Kornyakov: flag for degamma
	bool hyperStars;   // Kornyakov: flag for hyper stars
	float starMaxRadius; // Kornyakov: maximum stars radius
