...
//! A sky layer is a graphical layer containing image or polygones displayed in the sky.
//! The StelSkyImageMgr allow to set the display order for layers, as well as opacity.
