...
\begin{enumerate}
\item Open the configuration window, select the location tab. Set the
  location to be somewhere in mid-Northern latitudes. The United
...
\item Now increase the time rate. Press \key{K}, \key{L}, \key{L},
  ...
  it takes for one day to pass as this accelerated rate.
\end{enumerate}
...
is measured clockwise round from due North\footnote{In some textbooks
  ...
  numbers with other sources.}. Hence North itself is $\degree$, East
