...
from Stellarium's Github website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.13}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.13; extended edition & \file{catalog-3.13.dat} &\texttt{432fe1814a471831874ba44dc8fb542b}& 28MB\\\bottomrule
\end{tabular}
...
JPL\footnote{\url{https://ssd.jpl.nasa.gov/pub/eph/planets/Linux/} (Also
