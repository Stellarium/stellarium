...
void AstroCalcCustomStepsDialog::createDialogContent()
{
	...
	//Signals and slots
	connect(&StelApp::getInstance(), &StelApp::languageChanged, this, &AstroCalcCustomStepsDialog::retranslate);
	...
	connect(ui->timeStepDoubleSpinBox, &QDoubleSpinBox::valueChanged, this, &AstroCalcCustomStepsDialog::saveTimeStep);

	populateUnitMeasurementsList();
	connect(ui->unitMeasurementComboBox, &QComboBox::currentIndexChanged, this, &AstroCalcCustomStepsDialog::saveUnitMeasurement);
	...
	connect(ui->sunAltitudeSpinBox,    &QDoubleSpinBox::valueChanged, this, &AstroCalcCustomStepsDialog::saveSunAltitude);
	connect(ui->sunAltCrossingComboBox, &QComboBox::currentIndexChanged, this, &AstroCalcCustomStepsDialog::saveSunAltitudeCrossing);
	...
	connect(ui->oppositionPlanetComboBox, &QComboBox::currentIndexChanged, this, &AstroCalcCustomStepsDialog::saveOppositionPlanet);
