...
void ExoplanetsDialog::setInfoHtml(void)
{
	...
	html += "<h2>" + q_("The proper names") + "</h2><ul>";
	...
	html += QString("<li><strong>%1</strong> (%2) &mdash; %3.</li>").arg(trans.qtranslate("Helvetios"), "51 Peg", q_("Helvetios is the Latin for <em>the Helvetian</em> and refers to the Celtic tribe that lived in Switzerland during the Middle Ages"));
	...
	html += QString("<li><strong>%1</strong><sup>*</sup> (%2) &mdash; %3.</li>").arg(trans.qtranslate("Lipperhey"), "55 Cnc d", q_("Hans Lipperhey (1570-1619) was a German-Dutch lens grinder and spectacle maker who is often attributed with the invention of the refracting telescope in 1608"));
	...
	html += QString("<li><strong>%1</strong> (%2) &mdash; %3.</li>").arg(trans.qtranslate("Hypatia"), "ι Dra b", q_("Hypatia was a famous Greek astronomer, mathmatician, and philosopher. She was head of the Neo-Platonic school at Alexandria in the early 5th century, until murdered by a Christian mob in 415"));
	...
	html += QString("<br /><sup>2</sup> %1.").arg(q_("The name originally proposed, Amaterasu, is already used for an asteroid"));
