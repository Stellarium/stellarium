...
\item The installation program will automatically install the
  ...
  by developer\footnote{StellariumScope User's Guide --- \url{http://welshdragoncomputing.ca/x/st/misc/stellariumscope_user_guide.2015.10.24.pdf}} so you can read it before installation.
