...
public:
	...
	LinearFader(int _duration=1000,
		...
		, is_transiting(false)
		, duration(_duration)
		, start_value(_state ? min_value : max_value)
		, target_value(_state ? max_value : min_value)
		, counter(0)
		, interstate(_state ? max_value : min_value)
	{
	}
...
public:
	// Create and initialise to default
	ParabolicFader(int _duration=1000, 
						float _min_value=0.0f, 
						float _max_value=1.0f, 
						bool _state=false) 
	  : Fader(_state, _min_value, _max_value)
