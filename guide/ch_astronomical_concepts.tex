...
As \name[Douglas]{Adams} (1952--2001) pointed out in the \emph{Hitchhiker's Guide to the
Galaxy}{\cite{THHG}},
\begin{quote}
...
\subsubsection{List of equations of $\Delta T$ in Stellarium}
...
\item[Morrison \& Stephenson (2004, 2005).] This important solution
  was published by L. V. Morrison and F. R. Stephenson in the article
...
\item[Stephenson, Morrison \& Hohenkerk (2016).] This important new solution was published by
  F. R. Stephenson,  L. V. Morrison and C. Y. Hohenkerk in the article 
  ``Measurement of the Earth’s rotation: 720 BC to AD 2015''~\cite{StephensonMorrisonHohenkerk:2016}. 
  The solution combines a spline fit to observations (used between the given limits) 
  with a parabolic fit (used outside the range).
  Recommended range of usage: between years -720 and 2016. $\dot{n}=-25.82''/\cy^2$.
...
\item[Espenak \& Meeus (2006).] This solution\footnote{This solution
  ...
  \& Stephenson~2004\cite{2004JHA....35..327M} and a polynomial fit
