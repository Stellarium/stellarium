...
const double LL = *L + (-0.02438225 - 0.00000541052*T) * T;
const double cosLL = cos(LL);
const double sinLL = sin(LL);
const double delta_L = (-0.09033 / 3600.0) + (0.03916 / 3600.0) * (cosLL + sinLL) * tan(*B);
const double delta_B = (0.03916 / 3600.0) * (cosLL - sinLL);
