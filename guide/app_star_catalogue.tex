...
\begin{itemize}
  \item \textbf{SIMBAD preparation} --- Python scripts from the companion
        ...
        \file{hip\_processed\_with\_binary.dat} that \program{hip2cat}
  ...
  \item \textbf{Catalogue generation} --- C++ tools in \file{util/gaiacat/}
        ...
        that \program{hip2cat} calls for the level~0--2 global-zone analysis.
        These are pure-offline once the Gaia \file{.bin} files and the
        SIMBAD table have been prepared. They generate levels~0--3
        (\program{hip2cat}) and 4--10 (\program{skychart2cat}) respectively.
\end{itemize}
...
\paragraph{Spectral and object type tables.} \program{hip2cat} needs the
...
\begin{commands}
hip2cat --simbad <hip_processed_with_binary.dat> --gaia-bin <dir>
...
\begin{commands}
skychart2cat --gaia-bin <dir> --out-dir <dir> [--work-dir <dir>]
