...
void ManualImportWindow::createDialogContent()
{
	...
	connect(ui->pushButtonSelectRingTexture, SIGNAL(clicked()), this, SLOT(selectRingTextureFile()));
        ...
        ui->labelLongitudeOfTheAscendingNode->setText(QString(q_("Longitude of the ascending node %1:")).arg(QChar(0x03A9)));//Capital omega
        ui->radioButtonArgumentOfPeriapsis->setText(QString(q_("Argument of periapsis %1:")).arg(QChar(0x3C9)));//Lowercase omega
        ui->radioButtonLongitudeOfPeriapsis->setText(QString(q_("Longitude of periapsis %1:")).arg(QChar(0x3D6)));
