...
Consolidated DSO catalog was created from various data:
...
Morphological classification and magnitudes (partially) for Melotte catalogue was taken from
DeepSkyPedia
http://deepskypedia.com/wiki/List:Melotte

Source code and source data for generate consolidated catalog of deep-sky objects can be 
obtained on Alexander Wolf's homepage: http://astro.altspu.ru/~aw/stellarium/DSOCat/
