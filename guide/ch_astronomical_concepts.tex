...
\item[Espenak \& Meeus (2006).] This solution by F. Espenak and
  J. Meeus, based on Morrison \& Stephenson~\cite{2004JHA....35..327M}
  and a polynomial fit through tabulated values for 1600-2000, is used
  for the NASA Eclipse Web
  Site\footnote{\url{http://eclipse.gsfc.nasa.gov/eclipse.html}} and
  in their ``Five Millennium Canon of Solar Eclipses: -1900 to
  ...
  3000. $\dot{n}=-25.858''/\cy^2$\footnote{This solution is used by
    default.}.
