...
\emph{Hotkey} & \emph{Field of view}&\emph{Hotkey} & \emph{Field of view}\\\midrule
  \key{\ctrl+\Alt+1}&180  &  \key{\ctrl+\Alt+6}& 10  \\
  \key{\ctrl+\Alt+2}& 90  &  \key{\ctrl+\Alt+7}&  5  \\
  \key{\ctrl+\Alt+3}& 60  &  \key{\ctrl+\Alt+8}&  2  \\
  \key{\ctrl+\Alt+4}& 45  &  \key{\ctrl+\Alt+9}&  1  \\
  \key{\ctrl+\Alt+5}& 20  &  \key{\ctrl+\Alt+0}& 0.5 \\\bottomrule
\end{tabular}
...
Goto                     & \guibutton[0.75]{2.5}{bt_goto.png}              & \key{\Space} & Center the view on the selected object \\
