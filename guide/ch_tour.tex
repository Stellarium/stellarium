...
The toolbars can be repositioned to any of the four corners of
the screen via the two checkboxes under \emph{Toolbar position} in the
\menu{Configuration~\textrightarrow~Tools} tab (see also
section~\ref{sec:gui:configuration:tools}). \newFeature{26.3} 
...
\bottomrule
\caption{Stellarium's standard menu buttons. Those marked \textsuperscript{\ref{fn:activate-buttons}} must be enabled first, see section~\ref{sec:gui:configuration:tools}.}
