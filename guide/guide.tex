...
\draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Stellarium User Guide\\[20pt] % Book title
...
\noindent \textsc{Version 0.15.0-1, typeset on \today}\\ % Publisher
