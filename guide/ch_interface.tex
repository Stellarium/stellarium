...
\begin{figure}[htbp]
\centering\includegraphics[width=0.68\textwidth]{astrocalc_dialog_positions2_tab}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\textwidth]{astrocalc_dialog_ephemeris_analemma}
