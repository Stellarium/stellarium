...
real ``dark mode''. To allow this, you can load an alternative style file.
...
online. You can find the file \file{normalStyle.css} in the program
directory's \file{data} subfolder. Copy this into your user directory
and rename it to e.g. \file{myOwnGreatStyle.css}. Edit numbers, but do
...
Note that, as Stellarium evolves, this file also may change from
version to version. We cannot give any guarantees that one customized
file will work on later or earlier versions of Stellarium.
