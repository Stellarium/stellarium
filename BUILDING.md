...
```
$ tar zxf stellarium-24.3.tar.gz
```
You should now have a directory `stellarium-24.3` with the source code in it.
...
On Windows save the file (`master.zip` or `stellarium-24.3.tar.gz`) to the `C:/Devel` directory as 
