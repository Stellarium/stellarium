...
void OcularDialog::initAboutText()
{
	...
	html += "<tr><td><strong>" + q_("Authors") + ":</strong></td><td>Timothy Reaves &lt;treaves@silverfieldstech.com&gt;<br />Bogdan Marinov<br />Pawel Stolowski (" + q_("Barlow lense feature") + ")</td></tr>";
	html += "</table>";
