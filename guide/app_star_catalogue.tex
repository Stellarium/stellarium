...
\begin{description}
\item[\file{stars\_0\_0v0\_7.cat}]
\item[\file{stars\_1\_0v0\_7.cat}]
\item[\file{stars\_2\_0v0\_7.cat}]
...
Data Type         &  4 & int & 4 & This describes the type of the file, which defines the size and structure 
...
Magnitude Minimum & 20 & int & 4 & The low bound of the magnitude scale for values in this file. 
...
%% TODO: There are still href links from the wiki. 
...
table~\ref{tab:Catalogues:stars:record:zones}. % \emph{Zones section}.
...
\begin{longtable}{llllp{55mm}}\toprule
\emph{Name} & \emph{Offset} & \emph{Type} & \emph{Size} &\emph{Description}\\\midrule
...
b\_v           &  9 & unsigned char      & 1 & This is the magnitude level in B-V colour. This value refers to one of 256 discrete steps 
                                               in the magnitude range for the file\\\midrule
mag            & 10 & unsigned char      & 1 & This is the magnitude level in the V-I colour. This value refers to one of 256 discrete steps 
                                               in the magnitude range for the file\\\midrule
...
b\_v & 68 bits & unsigned int &  7 bits & This is the magnitude level in B-V colour. This value refers to one of 128 discrete steps 
                                          in the magnitude range for the file\\\midrule
mag  & 75 bits & unsigned int &  5 bits & This is the magnitude level in the V-I colour. This value refers to one of 32 discrete steps 
...
b\_v & 36 bits & unsigned int &  7 bits & This is the magnitude level in B-V colour. This value refers to one of 128 discrete steps 
                                          in the magnitude range for the file\\\midrule
mag  & 43 bits & unsigned int &  5 bits & This is the magnitude level in the V-I colour. This value refers to one of 32 discrete steps 
                                          in the magnitude range for the file\\\bottomrule
\end{tabularx}
...
The \file{gcvs\_hip\_part.dat} file contains data about 6916 Variable Stars 
...
edition of the GCVS%~\cite{GCVS4}, %%%%%%%%% TODO: ADD REFERENCE
...
\subsubsection{The new variability types}
\label{the-new-variability-types}

The new variability types have been added in the Name-Lists 67- 77 and
in the GCVS vol.V.
% TODO: ADD REFERENCES PROPERLY!
