...
namespace StelContributors {
    ...
    static const QStringList contributorsList =
    {
        ...
        "Daniel Adastra", "sebagr", "Adam Majer", "Alexander Belopolsky", "Alexander Miller", 
        "Andrew Jeddeloh", "Angelo Fraietta", "Annette S. Lee", "Antoine Jacoutot", "Arjen de Korte", 
        "Aspere", "Bernd K", "Björn Höfling", "Brian Kloppenborg", "Cassy", 
        "Chi Huynh", "Clepalitto", "Cosimo Cecchi", "Dan Joplin", "Daniel De Mickey", 
        "Daniel Michalik", "Danny Milosavljevic", "Dempsey-p", "Dhia", "Dominik Maximilián Ramík", 
        "François Scholder", "Froenchenko Leonid", "Gion Kunz", "GitHaarek", "Gábor Péterffy", 
        "Holger", "JMejuto", "Jack Schmidt", "Jean-Philippe Lambert", "Jocelyn GIROD", 
        "Katrin Leinweber", "Kenan Dervišević", "Louis Strous", "M.S. Adityan", "Matt Hughes", 
