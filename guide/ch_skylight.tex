...
This model \newFeature{26.2} combines a realistic view of the sky as in ShowMySky with light weight of the Preetham model, at the cost of being fixed to simulating a sea level sky (just as Preetham), lacking the realism of eclipse simulation (also as Preetham), and having no parameters to tweak.
