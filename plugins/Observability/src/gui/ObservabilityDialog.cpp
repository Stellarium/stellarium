...
void ObservabilityDialog::setAboutHtml(void)
{
	...
	html += "<h3>" + q_("Explanation of some parameters<br>") + "</h3><table width=\"90%\">";
	...
	html += QString("<tr><td>%1</td><td>%2</td></tr>").arg(q_("Full Moon:")).arg(q_("When the Moon is selected, the program can compute the exact closest dates (up to 1 minute accuracy) of the Moon's opposition to the Sun."));
	html += "</table>";
	html += "</body></html>";
