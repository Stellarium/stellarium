...
OcularsGuiPanel::OcularsGuiPanel(Oculars * plugin, QGraphicsWidget * parent)
   ...
   , borderPath(Q_NULLPTR)
{
   ...
   actionMgr->addAction("actionToggle_Oculars_Previous_Ocular",
                        ocularsGroup,
                        N_("Previous ocular"),
                        this,
                        ...
                        "");
   actionMgr->addAction(
     "actionToggle_Oculars_Next_Ocular", ocularsGroup, N_("Next ocular"), this, "updateOcularControls()", "", "");
   actionMgr->addAction(
     "actionToggle_Oculars_Previous_Lens", ocularsGroup, N_("Previous lens"), this, "updateLensControls()", "", "");
   actionMgr->addAction(
     "actionToggle_Oculars_Next_Lens", ocularsGroup, N_("Next lens"), this, "updateLensControls()", "", "");
   actionMgr->addAction(
     "actionToggle_Oculars_Previous_CCD", ocularsGroup, N_("Previous CCD frame"), this, "updateCcdControls()", "", "");
   actionMgr->addAction(
     "actionToggle_Oculars_Next_CCD", ocularsGroup, N_("Next CCD frame"), this, "updateCcdControls()", "", "");
   actionMgr->addAction("actionToggle_Oculars_Previous_Telescope",
                        ocularsGroup,
                        N_("Previous telescope"),
                        this,
                        "updateTelescopeControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Next_Telescope",
                        ocularsGroup,
                        N_("Next telescope"),
                        this,
                        "updateTelescopeControls()",
   ...
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_Reset",
                        ocularsGroup,
                        N_("Reset the sensor frame rotation"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_15_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 15 degrees counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_5_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 5 degrees counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_1_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 1 degree counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_15_Clockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 15 degrees clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_5_Clockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 5 degrees clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Frame_1_Clockwise",
                        ocularsGroup,
                        N_("Rotate the sensor frame 1 degree clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");

   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_Reset",
                        ocularsGroup,
                        N_("Reset the prism rotation"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_15_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the prism 15 degrees counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_5_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the prism 5 degrees counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_1_Counterclockwise",
                        ocularsGroup,
                        N_("Rotate the prism 1 degree counterclockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_15_Clockwise",
                        ocularsGroup,
                        N_("Rotate the prism 15 degrees clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_5_Clockwise",
                        ocularsGroup,
                        N_("Rotate the prism 5 degrees clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   actionMgr->addAction("actionToggle_Oculars_Rotate_Prism_1_Clockwise",
                        ocularsGroup,
                        N_("Rotate the prism 1 degree clockwise"),
                        this,
                        "updateCcdControls()",
                        "",
                        "");
   ...
   prevOcularButton =
     new StelButton(ocularControls, prevArrow, prevArrowOff, QPixmap(), "actionToggle_Oculars_Previous_Ocular");
   prevOcularButton->setToolTip(q_("Previous ocular"));
   nextOcularButton =
     new StelButton(ocularControls, nextArrow, nextArrowOff, QPixmap(), "actionToggle_Oculars_Next_Ocular");
   nextOcularButton->setToolTip(q_("Next ocular"));
   prevLensButton =
     new StelButton(lensControls, prevArrow, prevArrowOff, QPixmap(), "actionToggle_Oculars_Previous_Lens");
   ...
   prevTelescopeButton =
     new StelButton(telescopeControls, prevArrow, prevArrowOff, QPixmap(), "actionToggle_Oculars_Previous_Telescope");
   prevTelescopeButton->setToolTip(q_("Previous telescope"));
   nextTelescopeButton =
     new StelButton(telescopeControls, nextArrow, nextArrowOff, QPixmap(), "actionToggle_Oculars_Next_Telescope");
   nextTelescopeButton->setToolTip(q_("Next telescope"));

   connect(prevOcularButton, &StelButton::triggered, ocularsPlugin, &Oculars::decrementOcularIndex);
   connect(nextOcularButton, &StelButton::triggered, ocularsPlugin, &Oculars::incrementOcularIndex);
   connect(prevTelescopeButton, &StelButton::triggered, ocularsPlugin, &Oculars::decrementTelescopeIndex);
   connect(nextTelescopeButton, &StelButton::triggered, ocularsPlugin, &Oculars::incrementTelescopeIndex);
   connect(prevCcdButton, &StelButton::triggered, ocularsPlugin, &Oculars::decrementCCDIndex);
   connect(nextCcdButton, &StelButton::triggered, ocularsPlugin, &Oculars::incrementCCDIndex);
   connect(nextLensButton, &StelButton::triggered, ocularsPlugin, &Oculars::incrementLensIndex);
   connect(prevLensButton, &StelButton::triggered, ocularsPlugin, &Oculars::decrementLensIndex);
   ...
   rotateCcdMinus15Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_15_Counterclockwise", true);
   rotateCcdMinus15Button->setToolTip(q_("Rotate the sensor frame 15 degrees counterclockwise"));
   rotatePrismMinus15Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_15_Counterclockwise", true);
   ...
   rotateCcdMinus5Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_5_Counterclockwise", true);
   rotateCcdMinus5Button->setToolTip(q_("Rotate the sensor frame 5 degrees counterclockwise"));
   rotatePrismMinus5Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_5_Counterclockwise", true);
   ...
   pOff     = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cOff);
   pHover   = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cHover);
   rotateCcdMinus1Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_1_Counterclockwise", true);
   rotateCcdMinus1Button->setToolTip(q_("Rotate the sensor frame 1 degree counterclockwise"));
   rotatePrismMinus1Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_1_Counterclockwise", true);
   ...
   pOff     = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cOff);
   pHover   = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cHover);
   resetCcdRotationButton =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_Reset", true);
   resetCcdRotationButton->setToolTip(q_("Reset the sensor frame rotation"));
   resetPrismRotationButton =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_Reset", true);
   ...
   pOff     = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cOff);
   pHover   = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cHover);
   rotateCcdPlus1Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_1_Clockwise", true);
   rotateCcdPlus1Button->setToolTip(q_("Rotate the sensor frame 1 degree clockwise"));
   rotatePrismPlus1Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_1_Clockwise", true);
   ...
   pOff     = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cOff);
   pHover   = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cHover);
   rotateCcdPlus5Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_5_Clockwise", true);
   rotateCcdPlus5Button->setToolTip(q_("Rotate the sensor frame 5 degrees clockwise"));
   rotatePrismPlus5Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_5_Clockwise", true);
   ...
   pOff     = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cOff);
   pHover   = createPixmapFromText(degrees, degreesW, lineHeight, newFont, cHover);
   rotateCcdPlus15Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Frame_15_Clockwise", true);
   rotateCcdPlus15Button->setToolTip(q_("Rotate the sensor frame 15 degrees clockwise"));
   rotatePrismPlus15Button =
     new StelButton(ccdControls, pOn, pOff, pHover, "actionToggle_Oculars_Rotate_Prism_15_Clockwise", true);
   ...
   connect(resetCcdRotationButton, &StelButton::triggered, [=]() { ocularsPlugin->ccdRotationReset(); });

   connect(rotateCcdMinus15Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotateCcdMinus5Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotateCcdMinus1Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotateCcdPlus1Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotateCcdPlus5Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotateCcdPlus15Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(resetCcdRotationButton, &StelButton::triggered, [=]() { updateCcdControls(); });
   ...
   connect(resetPrismRotationButton, &StelButton::triggered, [=]() { ocularsPlugin->prismPositionAngleReset(); });

   connect(rotatePrismMinus15Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotatePrismMinus5Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotatePrismMinus1Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotatePrismPlus1Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotatePrismPlus5Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(rotatePrismPlus15Button, &StelButton::triggered, [=]() { updateCcdControls(); });
   connect(resetPrismRotationButton, &StelButton::triggered, [=]() { updateCcdControls(); });
...
void OcularsGuiPanel::updatePosition()
{
   ...
   QPointF      cornerArcStart(verticalBorderStart.x(), horizontalBorderEnd.y() - cornerRadius);
...
void OcularsGuiPanel::updateOcularControls()
{
   ...
   if (ocular->isBinoculars()) {
      ...
      QString apparentFovLabel = QString(q_("Ocular aFOV: %1")).arg(apparentFovString);
...
void OcularsGuiPanel::updateLensControls()
{
   ...
   if (lens != Q_NULLPTR) {
      ...
      multiplerString = QString(q_("Multiplicity: %1")).arg(lens->multiplier());
...
void OcularsGuiPanel::updateCcdControls()
{
   ...
   auto  lens             = ocularsPlugin->selectedLens();

   qreal posX             = 0.0;
   qreal posY             = 0.0;
   qreal widgetWidth      = 0.0;
   qreal widgetHeight     = 0.0;

   // Prev button
   qreal heightAdjustment = (fieldCcdName->boundingRect().height() - prevCcdButton->boundingRect().height()) / 2.0;
   ...
   auto         dimensionsLabel = QString(q_("Dimensions: %1")).arg(ocularsPlugin->getDimensionsString(fovX, fovY));
   ...
   QString unit = q_("\"/px");
   fieldCcdHScale->setPlainText(
     QString("%1: %2%3")
       .arg(q_("X scale"), QString::number(fovX * 3600 * ccd->binningX() / ccd->resolutionX(), 'f', 4), unit));
   ...
   fieldCcdVScale->setPlainText(
     QString("%1: %2%3")
       .arg(q_("Y scale"), QString::number(fovY * 3600 * ccd->binningY() / ccd->resolutionY(), 'f', 4), unit));
...
void OcularsGuiPanel::updateTelescopeControls()
{
   ...
   // Prev button
   qreal heightAdjustment =
     (fieldTelescopeName->boundingRect().height() - prevTelescopeButton->boundingRect().height()) / 2.0;
   ...
   if (ocularsPlugin->flagShowCCD) {
      ...
      auto fovX            = ccd->getActualFOVx(telescope, lens);
      auto fovY            = ccd->getActualFOVy(telescope, lens);
      auto dimensionsLabel = QString(q_("Dimensions: %1")).arg(ocularsPlugin->getDimensionsString(fovX, fovY));
      fieldCcdDimensions->setPlainText(dimensionsLabel);
      fieldCcdDimensions->setToolTip(q_("Dimensions field of view"));
   ...
   if (ocularsPlugin->flagShowOculars) {
      ...
      auto magnificationString = QString::number(mag, 'f', 1);
      ...
      if (mag > 0) {
         ...
         auto exitPupilLabel = QString(q_("Exit pupil: %1 mm")).arg(QString::number(exitPupil, 'f', 2));
      ...
      auto fovString = QString::number(ocular->actualFOV(telescope, lens), 'f', 4) + QChar(0x00B0);
      auto fovLabel  = QString(q_("FOV: %1")).arg(fovString);
      ...
      fieldExitPupil->setVisible(mag > 0);
   }
   ...
   if (diameter > 0.0 && ocularsPlugin->getFlagShowResolutionCriteria()) {
      ...
      auto dawesLabel = QString("%1: %2\"").arg(q_("Dawes' limit")).arg(QString::number(116 / diameter, 'f', 2));
      ...
      auto abbeyLabel = QString("%1: %2\"").arg(q_("Abbe's limit")).arg(QString::number(113 / diameter, 'f', 2));
      ...
      auto sparrowLabel = QString("%1: %2\"").arg(q_("Sparrow's limit")).arg(QString::number(108 / diameter, 'f', 2));
   ...
   if (ocularsPlugin->flagShowOculars && ocularsPlugin->getFlagShowResolutionCriteria() && diameter > 0.0) {
      ...
      auto visualResolutionLabel = QString("%1: %2\"").arg(q_("Visual resolution")).arg(QString::number(vres, 'f', 2));
...
{
   auto  n       = buttonCrosshairs->isVisible() ? 5 : 4;
   auto  width   = n * buttonOcular->getButtonPixmapWidth();

   // Relative position inside the parent widget
   qreal posX    = 0.0;
   qreal posY    = 0.0;
   qreal spacing = 0.0;
   if (prevTelescopeButton != nullptr) {
      width += 2 * prevTelescopeButton->getButtonPixmapWidth();
      posX = prevTelescopeButton->getButtonPixmapWidth();
   }
   if (((buttonOcular->parentItem()) != nullptr) && ((buttonOcular->parentItem()->parentItem()) != nullptr)) {
      auto parentWidth = buttonOcular->parentItem()->parentItem()->boundingRect().width();
      auto nGaps       = n - 1; // n buttons have n-1 gaps
...
auto OcularsGuiPanel::createPixmapFromText(const QString & text,
                                           int             width,
                                           int             height,
                                           const QFont &   font,
                                           const QColor &  textColor,
                                           const QColor &  backgroundColor) -> QPixmap
{
   if (width <= 0 || height <= 0) {
      return QPixmap();
   }
