...
QString NomenclatureItem::getNomenclatureTypeLatinString(NomenclatureItemType nType)
{
	static const QMap<NomenclatureItemType, QString>map = {
		{ niSpecialPointPole    , L1S("point") },
		{ niSpecialPointEast    , L1S("point") },
		{ niSpecialPointWest    , L1S("point") },
		{ niSpecialPointCenter  , L1S("point") },
		{ niSpecialPointSubSolar, L1S("point") },
		{ niArcus               , L1S("arcus") },
		{ niAstrum              , L1S("astrum") },
		{ niCatena              , L1S("catena") },
		{ niCavus               , L1S("cavus") },
		...
		{ niFarrum              , L1S("farrum") },
		{ niFlexus              , L1S("flexus") },
		{ niFluctus             , L1S("fluctus") },
		{ niFlumen              , L1S("flumen") },
		{ niFretum              , L1S("fretum") },
		{ niFossa               , L1S("fossa") },
		{ niInsula              , L1S("insula") },
		{ niLabes               , L1S("labes") },
		{ niLabyrinthus         , L1S("labyrinthus") },
		{ niLacuna              , L1S("lacuna") },
		{ niLacus               , L1S("lacus") },
		{ niLenticula           , L1S("lenticula") },
		{ niLinea               , L1S("linea") },
		{ niLingula             , L1S("lingula") },
		{ niMacula              , L1S("macula") },
		{ niMare                , L1S("mare") },
		{ niMensa               , L1S("mensa") },
		{ niMons                , L1S("mons") },
		{ niOceanus             , L1S("oceanus") },
		{ niPalus               , L1S("palus") },
		{ niPatera              , L1S("patera") },
		{ niPlanitia            , L1S("planitia") },
		{ niPlanum              , L1S("planum") },
		{ niPlume               , L1S("plume") },
		{ niPromontorium        , L1S("promontorium") },
		{ niRegio               , L1S("regio") },
		{ niReticulum           , L1S("reticulum") },
		{ niRima                , L1S("rima") },
		{ niRupes               , L1S("rupes") },
		{ niSaxum               , L1S("saxum") },
		{ niScopulus            , L1S("scopulus") },
		{ niSerpens             , L1S("serpens") },
		{ niSulcus              , L1S("sulcus") },
		{ niSinus               , L1S("sinus") },
		{ niTerra               , L1S("terra") },
		{ niTessera             , L1S("tessera") },
		{ niTholus              , L1S("tholus") },
		{ niUnda                , L1S("unda") },
		{ niVallis              , L1S("vallis") },
		{ niVastitas            , L1S("vastitas") },
		{ niVirga               , L1S("virga") }};
...
QString NomenclatureItem::getNarration(const StelCore* core, const InfoStringGroup& flags) const
{
	QString str;
	QTextStream oss(&str);
	const bool withDecimalDegree = StelApp::getInstance().getFlagShowDecimalDegrees();
	...
	if (flags&Name)
	{
		...
		// englishName here is the original scientific term, usually latin but could be plain english like "landing site".
		if (nameI18n!=englishName && nType<NomenclatureItemType::niSpecialPointPole)
			oss << qc_("or", "object narration") << " " << englishName;
		oss << ". ";
	}
	...
	{
		if (!origin.isEmpty())
			oss << QString("%1: %2. ").arg(qc_("The feature was named after", "object narration"), originI18n);
	}
	if (flags&OtherCoord)
	{
		...
		if (nType>=NomenclatureItemType::niSpecialPointEast && planet->getEnglishName()=="Jupiter")
		{
			...
			lng   = StelUtils::fmodpos(lng, 360.);
			sLong = StelUtils::decDegToLongitudeNarration(360.-lng, isEastPositive(), is180(), !withDecimalDegree);
			sLat  = StelUtils::decDegToLatitudeNarration(lat, !withDecimalDegree);
		}
...
NomenclatureItem::NomenclatureItemType NomenclatureItem::getNomenclatureItemType(const QString &abbrev)
{
	...
	static const QMap<QString, NomenclatureItem::NomenclatureItemType> niTypes = {
		{ L1S("AL"), NomenclatureItem::niAlbedoFeature	},
		{ L1S("AR"), NomenclatureItem::niArcus		},
		{ L1S("AS"), NomenclatureItem::niAstrum		},
		{ L1S("CA"), NomenclatureItem::niCatena		},
		{ L1S("CB"), NomenclatureItem::niCavus		},
		{ L1S("CH"), NomenclatureItem::niChaos		},
		{ L1S("CM"), NomenclatureItem::niChasma		},
		{ L1S("CO"), NomenclatureItem::niCollis		},
		{ L1S("CR"), NomenclatureItem::niCorona		},
		{ L1S("AA"), NomenclatureItem::niCrater		},
		{ L1S("DO"), NomenclatureItem::niDorsum		},
		{ L1S("ER"), NomenclatureItem::niEruptiveCenter	},
		{ L1S("FA"), NomenclatureItem::niFacula		},
		{ L1S("FR"), NomenclatureItem::niFarrum		},
		{ L1S("FE"), NomenclatureItem::niFlexus		},
		{ L1S("FL"), NomenclatureItem::niFluctus		},
		{ L1S("FM"), NomenclatureItem::niFlumen		},
		{ L1S("FO"), NomenclatureItem::niFossa		},
		{ L1S("FT"), NomenclatureItem::niFretum		},
		{ L1S("IN"), NomenclatureItem::niInsula		},
		{ L1S("LA"), NomenclatureItem::niLabes		},
		{ L1S("LB"), NomenclatureItem::niLabyrinthus		},
		{ L1S("LU"), NomenclatureItem::niLacuna		},
		{ L1S("LC"), NomenclatureItem::niLacus		},
		{ L1S("LF"), NomenclatureItem::niLandingSite		},
		{ L1S("LG"), NomenclatureItem::niLargeRingedFeature	},
		{ L1S("LE"), NomenclatureItem::niLenticula		},
		{ L1S("LI"), NomenclatureItem::niLinea		},
		{ L1S("LN"), NomenclatureItem::niLingula		},
		{ L1S("MA"), NomenclatureItem::niMacula		},
		{ L1S("ME"), NomenclatureItem::niMare		},
		{ L1S("MN"), NomenclatureItem::niMensa		},
		{ L1S("MO"), NomenclatureItem::niMons		},
		{ L1S("OC"), NomenclatureItem::niOceanus		},
		{ L1S("PA"), NomenclatureItem::niPalus		},
		{ L1S("PE"), NomenclatureItem::niPatera		},
		{ L1S("PL"), NomenclatureItem::niPlanitia		},
		{ L1S("PM"), NomenclatureItem::niPlanum		},
		{ L1S("PU"), NomenclatureItem::niPlume		},
		{ L1S("PR"), NomenclatureItem::niPromontorium	},
		{ L1S("RE"), NomenclatureItem::niRegio		},
		{ L1S("RT"), NomenclatureItem::niReticulum		},
		{ L1S("RI"), NomenclatureItem::niRima		},
		{ L1S("RU"), NomenclatureItem::niRupes		},
		{ L1S("SA"), NomenclatureItem::niSaxum		},
		{ L1S("SF"), NomenclatureItem::niSatelliteFeature	},
		{ L1S("SC"), NomenclatureItem::niScopulus		},
		{ L1S("SE"), NomenclatureItem::niSerpens		},
		{ L1S("SI"), NomenclatureItem::niSinus		},
		{ L1S("SU"), NomenclatureItem::niSulcus		},
		{ L1S("TA"), NomenclatureItem::niTerra		},
		{ L1S("TE"), NomenclatureItem::niTessera		},
		{ L1S("TH"), NomenclatureItem::niTholus		},
		{ L1S("UN"), NomenclatureItem::niUnda		},
		{ L1S("VA"), NomenclatureItem::niVallis		},
		{ L1S("VS"), NomenclatureItem::niVastitas		},
		{ L1S("VI"), NomenclatureItem::niVirga		}};
...
NomenclatureItem::PlanetCoordinateOrientation NomenclatureItem::getPlanetCoordinateOrientation(const QString &planetName)
{
	...
	{L1S("Ariel")      , NomenclatureItem::pcoPlanetocentricEast360 },
	//{"Callisto"   , NomenclatureItem::pcoPlanetographicWest360 },
	{L1S("Charon")     , NomenclatureItem::pcoPlanetocentricEast360 },
	...
	{L1S("Mars")       , NomenclatureItem::pcoPlanetocentricEast360 }, // MDIM 2.1
	...
	{L1S("Miranda")    , NomenclatureItem::pcoPlanetocentricEast360 },
	{L1S("Moon")       , NomenclatureItem::pcoPlanetographicEast180 }, // LOLA 2011 ULCN 2005
	{L1S("Oberon")     , NomenclatureItem::pcoPlanetocentricEast360 },
	//{"Phobos"     , NomenclatureItem::pcoPlanetographicWest360 },
	//{"Phoebe"     , NomenclatureItem::pcoPlanetographicWest360 },
	{L1S("Pluto")      , NomenclatureItem::pcoPlanetocentricEast360 },
	//{"Proteus"    , NomenclatureItem::pcoPlanetographicWest360 },
	{L1S("Puck")       , NomenclatureItem::pcoPlanetocentricEast360 },
	...
	{L1S("Titania")    , NomenclatureItem::pcoPlanetocentricEast360 },
	{L1S("Triton")     , NomenclatureItem::pcoPlanetographicEast360 },
	{L1S("Umbriel")    , NomenclatureItem::pcoPlanetocentricEast360 },
	{L1S("Venus")      , NomenclatureItem::pcoPlanetocentricEast360 }};
