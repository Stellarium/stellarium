...
\begin{itemize}		
  ...
  \item Parts of the code to compute $\Delta T$ for JPL Horizons algorithm requires access to Essential Routines for Fundamental Astronomy (ERFA, version 2.0.1) (Three Clause BSD license).\newFeature{26.1}
\end{itemize}
