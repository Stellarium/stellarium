...
space observatory mission which observed a small field in the Cyg/Lib/Dra area. Accordingly 
...
respective tab and press \button{Query}. The result is displayed in a browser view\footnote{%
For technical reasons, on some platforms the result is displayed in the system's default web browser.}.
...
\noindent Regardless of the current program language, the result is always
