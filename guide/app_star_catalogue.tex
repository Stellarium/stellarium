...
Since version 0.14.0 Stellarium supports cross-identification between stars from Hipparcos (HIP)~\cite{2012AstL...38..331A}, Smithsonian Astrophysical Observatory (SAO) Star Catalog J2000.0 (SAO), Henry Draper Catalogue and Extension (HD)~\cite{1993yCat.3135....0C} and $5^{th}$ Revised Ed. of Bright Star (Hoffleit+, 1991; HR)~\cite{1964cbs..book.....H} catalogues.
...
The \textbf{cross-id.dat} file contains cross reference data for catalogues HIP, SAO, HD and HR, which stored in the plain text format with tab delimiter.

\begin{longtabu} to \textwidth {l|l|l|X}\toprule
	\emph{Name} & \emph{Type} & \emph{Description}\\\midrule
	HIP	& int & This is the HIP identificator for the star. Used for reference to the main star catalogue.\\\midrule
	SAO	& int & This is the SAO identificator for the star.\\\midrule
	HD	& int & This is the HD identificator for the star.\\\midrule
	HR	& int & This is the HR identificator for the star.\\\bottomrule
\end{longtabu}
