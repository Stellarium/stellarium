...
\input{plg_scenery3d}
%%TODO: Satellites, MeteorShowers, Scenery3D&ArchaeoLines, TelescopeControl, Oculars
...
\include{scripting_api}

%----------------------------------------------------------------------------------------
%	CHAPTER E (Accuracy, and some notes about used algorithms.)
%----------------------------------------------------------------------------------------

\include{accuracy}%% This could go to the front as section of a chapter "Scientific Use"
