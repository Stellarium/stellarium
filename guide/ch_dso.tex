...
Stellarium's DSO Catalog contains over 83000 objects\footnote{The extended edition of this catalog with over one million objects may be downloaded and installed by hands (see section  \ref{sec:ExtraData:DSOs}).} and is available for end users as collection of files:
