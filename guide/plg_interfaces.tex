...
The file will be taken from the user data directory if it also exists, which means that users can add minor planets or comets as they become observable by editing this file.
