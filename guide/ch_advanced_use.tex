...
Your master application must obviously embed a \program{Spout} receiver. If you need more than one instance of Stellarium, 
you can use option \texttt{-\/-spout-name=StelSpout2} to create another \program{Spout} sender without a name conflict. 
In such cases, it may be useful to also have separate user data directories and use option \texttt{-\/-use-dir}. 
