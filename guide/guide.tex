...
\draw[anchor=north] (midpoint) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering Stellarium User Guide\\[18pt] % Book title
{\Large Matthew Gates, Alexander Wolf, Barry Gerdes, Georg Zotti}\\[15pt]%
{\Large Version 0.15.0-1}\\[15pt] % Subtitle
{\Large 2016} % Subtitle
}}; % Author name
\end{tikzpicture}};
\end{tikzpicture}
...
\noindent Copyright \copyright\ 2011-2015 Alexander Wolf.\\ % Copyright notice
