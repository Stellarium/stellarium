...
\newFeature{0.15.1}Similarly, pressing \keys{\ctrl+\space} and scrolling the mouse wheel will 
advance time by minutes, and pressing \keys{\ctrl+\shift+\space} before 
scrolling the mouse wheel will advance time by hours.
...
Nebula images            & \guibutton[0.75]{2.5}{bt_DSS}        & \key{I} & Toggle ``nebula images''. This button must be enabled first, see section~\ref{sec:gui:configuration:tools}\\
