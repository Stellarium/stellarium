...
<p>Alfred Maaß made a report about his journey into an article titled "Astrologische Kalender der Balinesen". In his article, he gave a description of each lintang in the Palelangan in the form of "Position in the Sky". But there are 10 lintangs that are not explained.
...
<table>
    ...
    <tr valign="top">
        ...
        <td>upside-down demon <br/>Sungsang itself is inverted. Kala also means time. So the duty of this demon is to remind people who forget or even neglect the time. </td>
    ...
    <tr valign="top">
        ...
        <td>keris (indigenous dagger)<br/>A royal spy code or women use this kind of dagger.</td>
        <td><img width="255" src="illustrations/descr_pics/Ra_Po.jpg"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Těnggala</notr></td>
        <td><notr>ᬢᭂᬗ᭄ᬕᬮ</notr></td>
        <td>a plough<br/>Betelgeuse is the red pain of the farmer. Bellatrix is the farmer's eye. Orion's belt is the plough. Rigel and other stars to the west are the animals (cow).</td>
        <td><img width="255" src="illustrations/descr_pics/Ra_Wa.jpg"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Laweyan</notr></td>
        <td><notr>ᬮᬯᬾᬬᬦ᭄</notr></td>
        <td>a headless demon<br/>This lintang is the lunar ascending node.</td>
        <td><img width="255" src="illustrations/descr_pics/Ra_Kli.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Klapa Sunda</notr></td>
        <td><notr>ᬓ᭄ᬮᬧᬲᬸᬦ᭄ᬤ</notr></td>
        <td>a leaning coconut tree<br/>There is a man in the coconut tree. He can't climb because there are two ants fighting on his foot.</td>
        <td><img width="255" src="illustrations/descr_pics/Ca_U.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Dupa</notr></td>
        <td><notr>ᬤᬸᬧ</notr></td>
        <td>an incence<br/>Balinese people see all comets as incences.</td>
    ...
    <tr valign="top">
        ...
        <td>a white ox<br/>A white cow.</td>
        <td><img width="255" src="illustrations/descr_pics/Ca_Wa.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Pědati Suung</notr></td>
        <td><notr>ᬧᭂᬤᬢᬶᬲᬸᬳᬸᬂ</notr></td>
        <td>an empty horse cart</td>
    ...
    <tr valign="top">
        ...
        <td>freshwater crab</td>
        <td><img width="255" src="illustrations/descr_pics/A_Pa.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Asu</notr></td>
        <td><notr>ᬳᬲᬸ</notr></td>
        <td>a dog<br/>It is not a usual dog, but Balinese dog. Balinese dogs are Proto-dogs or street dogs.  </td>
    ...
    <tr valign="top">
        ...
        <td>a pig<br/>Wild boar </td>
        <td><img width="255" src="illustrations/descr_pics/A_Kli.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Tangis</notr></td>
        <td><notr>ᬢᬗᬶᬲ᭄</notr></td>
        <td>tears (mourning the dead)<br/>Mourning person because a loved one died</td>
        <td><img width="255" src="illustrations/descr_pics/Bu_U.png"/></td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>bringing corpse to cremation<br/>This is the stage when the corpse has been purified and the people bring the corpse to the cremation place </td>
    ...
    <tr valign="top">
        ...
        <td>error measurement<br/>The man with keris tries to fight a big animal<br/>The unbalance of the human size and the big animal stands for this lintang. </td>
        <td><img width="255" src="illustrations/descr_pics/Wra_Pa.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Bade</notr></td>
        <td><notr>ᬩᬤᬾ</notr></td>
        <td>funeral bier<br/>Name for corpse tower in Hindu Bali rituals. Bade has different levels depending on the caste and size of the event.  </td>
        <td><img width="255" src="illustrations/descr_pics/Wra_Po.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Kumba</notr></td>
        <td><notr>ᬓᬸᬫ᭄ᬩ</notr></td>
        <td>an earthen vessel<br/>This vessel contains holy water. </td>
        <td><img width="255" src="illustrations/descr_pics/Wra_Wa.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Naga</notr></td>
        <td><notr>ᬦᬕ</notr></td>
        <td>a dragon<br/>Naga are mystical creatures with special powers. The famous Naga Basuki, in particular, is the one that connected to the Bali Strait. </td>
        <td><img width="255" src="illustrations/descr_pics/Wra_Kli.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Banyak Angrěm</notr></td>
        <td><notr>ᬩᬜᬓ᭄ᬳᬗᬺᬫ᭄</notr></td>
        <td>the brooding Goose</td>
    ...
    <tr valign="top">
        ...
        <td>a broken ship</td>
        <td><img width="255" src="illustrations/descr_pics/Su_Po.png"/></td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>a prawn <br/>A shrimp.</td>
        <td><img width="255" src="illustrations/descr_pics/Su_Kli.png"/></td>
    </tr>
    <tr valign="top">
        <td><notr>Děpat</notr></td>
        <td><notr>ᬤᭂᬧᬢ᭄</notr></td>
        <td>demon without body<br/>This is the head of Laweyan. This lintang is the lunar descending node.</td>
    ...
    <tr valign="top">
        ...
        <td><img width="255" src="illustrations/descr_pics/Sa_Wa.png"/></td>
    </tr>
    <tr valign="top">
...
<p>Paintings by: <em>Jessica Gullberg </em></p>
