...
\item[generic] --- use this value for subset of ``western'' cultures to enable using default (IAU) boundaries.
...
\begin{description}
  \item[personal] -- this is a personally developed skyculture which
    is not funded in published historical or ethnological research. Stellarium
