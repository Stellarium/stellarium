...
\item You can also connect to another computer which runs
  ...
  or even your smartphone. Apps like \program{BlueNMEA} can provide
  these data, but make sure to configure hostname/IP Address and port
  number correctly.  To configure this, you must manually edit
