...
public:	
	...
	virtual QString getName() const  Q_DECL_OVERRIDE{ return "Bright Novae"; }
	virtual QString getStelObjectType() const Q_DECL_OVERRIDE { return Nova::NOVA_TYPE; }
