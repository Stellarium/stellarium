...
#ifndef _STELDIALOGOCULARS_HPP_
#define _STELDIALOGOCULARS_HPP_
...
class StelDialogOculars : public QObject
{
	Q_OBJECT
public:
	StelDialogOculars();
	virtual ~StelDialogOculars();
