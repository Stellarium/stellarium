...
private:
	...
	enum WUTCategory {
		...
		ew_dark_nebulae,
		ew_galaxies,
		ew_open_star_clusters,
		ew_asteroids,
		ew_comets,
		ew_plutinos,
		ew_dwarf_planets,
		ew_cubewanos,
		ew_scattered_disc_objects,
		ew_Oort_cloud_objects,
		ew_sednoids,
		ew_planetary_nebulae,
		ew_bright_double_stars,
		ew_bright_variable_stars,
		ew_bright_stars_with_high_proper_motion,
		ew_eclipsing_close_binaries,	// http://www.sai.msu.su/gcvs/gcvs/vartype.htm
		ew_symbiotic_stars,
		ew_emission_line_stars,
		ew_supernovae_candidates,
		ew_supernovae_remnant_candidates,
		ew_supernovae_remnants,
		ew_clusters_of_galaxies,
		ew_interstellar_objects,
		ew_globular_star_clusters,
		ew_regions_of_the_sky,
		ew_active_galaxies,
		ew_pulsars,
		ew_exoplanetary_systems,
		ew_bright_nova_stars,
		ew_bright_supernova_stars,
		ew_interacting_galaxies,
		ew_deep_sky_objects,
		ew_Messier_objects,
		ew_NGC_IC_objects,
		ew_Caldwell_objects,
		ew_Herschel_400_objects,

		ew_none	// stop gapper for syntax reasons
	};
};
