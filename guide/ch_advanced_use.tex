...
from Stellarium's Github website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.22}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version; Edition} & \emph{Filename} & \emph{MD5 hash} & \emph{Size}\\\midrule
3.22; extended & \file{catalog-3.22.dat} & \texttt{c4820d050791046baf1460b186fa23c6} & 28MB\\\bottomrule
\end{tabular}
