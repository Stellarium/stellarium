...
private:
	...
	s_tui::MenuBranch* tui_menu_create_avi;
	...
	s_tui::Decimal_item* tui_star_maxradius;
  s_tui::Decimal_item* tui_star_limiting_mag;
	...
	s_tui::MultiSet_item<wstring>* tui_scripts_local_edit;
	...
	// 8. Create avi 
	s_tui::MultiSet_item<wstring>* tui_scripts_create_avi;
	...
	void tui_cb_scripts_create_avi();        // changed script for creating avi
	void tui_cb_scripts_local_edit();        // changed script for editing in the notepad
