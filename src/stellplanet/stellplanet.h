...
void get_sun_helio_coordsv(double JD, double* XYZ);
void get_mercury_helio_coordsv(double JD, double* XYZ);
void get_venus_helio_coordsv(double JD, double* XYZ);
void get_earth_helio_coordsv(double JD, double* XYZ);
void get_mars_helio_coordsv(double JD, double* XYZ);
void get_jupiter_helio_coordsv(double JD, double* XYZ);
void get_saturn_helio_coordsv(double JD, double* XYZ);
void get_uranus_helio_coordsv(double JD, double* XYZ);
void get_neptune_helio_coordsv(double JD, double* XYZ);
void get_pluto_helio_coordsv(double JD, double* XYZ);
