#!/usr/bin/env python3
# ==============================================================================
# WARNING: This script is SLOW and memory-intensive (~4-8 GB per worker thread).
# It was written for a one-shot run on a 128 GB / 64-core server and is provided
# primarily for ALGORITHM VERIFICATION. A more efficient C++ version suitable for
# consumer hardware is being developed separately.
# ==============================================================================
...
Usage: python gaia_skychart_to_cat.py --skychart DIR --out-dir DIR
"""
