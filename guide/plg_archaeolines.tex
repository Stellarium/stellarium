...
configuration window. Default locations are Makkah (the black Kaaba 
monument defining prayer direction, or \emph{qiblah}) and
...
and also\newFeature{26.3} distances (angular degrees on a spherical earth, and kilometers on the flattened earth) are displayed.
...
geographic\_location\_1\_name      &string  & Makkah (Qibla) \\
geographic\_location\_2\_longitude &double  & 35.235774     \\
geographic\_location\_2\_latitude  &double  & 31.778087     \\
geographic\_location\_2\_name      &string  & Jerusalem     \\\midrule
