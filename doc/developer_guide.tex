...
Project managment is done using sourceforge.net services for cvs hosting, bug tracking, forums etc.. Globally, everything usefull for the project is available at the main project page \htmladdnormallink{http://sourceforge.net/projects/stellarium/}.
...
Here are the first steps to start working on the sourcecode : (see detailed instructions from \htmladdnormallink{http://sourceforge.net/cvs/?group\_id=48857})
