...
\newcommand{\button}[1]{\textbf{\textsf{#1}}}% Will become a boxed text, representing a GUI button label.
...
\lstnewenvironment{script}{\lstset{language=PHP,%
...
\usepackage{hyperref}
\hypersetup{hidelinks,backref=true,pagebackref=true,hyperindex=true,colorlinks=false,breaklinks=true,urlcolor= ocre,
            pdfpagemode=UseOutlines,bookmarks=true,bookmarksopen=true,%bookmarksopenlevel=1,bookmarksnumbered,
            pdfview=Fit,pdfstartview=Fit,pdfpagelayout=TwoPageRight,
            pdfduplex=true,%does nothing? 
            ...
            pdfauthor={M. Gates, B. Gerdes, A. Wolf, G. Zotti}% 
            }
