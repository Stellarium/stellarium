...
\item[Use designations for screen labels] --- when this option is enabled you will see 
  in the sky (on-screen labels) only scientific designations of the stars instead of their common names. To customization\newFeature{0.21.3} the on-screen labels we added 3 additional items\footnote{All of these items work independently to the parent option.} --- \textbf{Dbl. stars}, \textbf{Var. stars} and \textbf{HIP} --- which will append to the on-screen labels old designations of double stars, designations of variable stars and HIP designation respectively. 
\end{description}
