...
\item[Byzantine Calendar] has month names and days identical to the Julian.\newFeature{26.2}  
  However, years are counted as \emph{annus mundi} (AM), 
  starting from Creation of the World on September 1, 5509 B.C. (Julian). 
  A question about Year Zero or negative years is pointless. 
  This calendar was used in Russia before introducing the Julian calendar in 1700. 
  Before that, from around 7th century to 1492 (unrelated to Columbus), start of the year was observed on March 1.
...
\item[Ethiopic] like the Coptic calendar, just with different
  year numbers, counted from the \emph{ethiopic era of mercy}.
...
\item[Maya Long Count] is a 5-part sequence of numbers, conventionally 
  ...
  systems, and of Long Count dates directly. Other scientists have\newFeature{26.3} 
  proposed different correlations. In the GUI tab \emph{Mesoamerica} 
  you can set your preferred correlation date.  

  %% Temporarily suppressed for space reasons. 
...
maya\_correlation\_jd        &int  & 584283\\
