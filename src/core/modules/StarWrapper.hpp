...
protected:
	...
	virtual ~StarWrapperBase(void) override {}
	virtual QString getType(void) const override {return STAR_TYPE;}
	virtual QString getObjectType(void) const override {return N_("star"); }
	virtual QString getObjectTypeI18n(void) const override {return q_(getObjectType()); }

	virtual QString getEnglishName(void) const override {return QString();}
	virtual QString getNameI18n(void) const override = 0;
...
protected:
	...
	virtual float getBV(void) const  override {return s->getBV();}
	//virtual QString getEnglishName(void) const override {return QString();}
	virtual QString getNameI18n(void) const override {return s->getNameI18n();}
protected:
...
public:
	...
	virtual QString getID(void) const override { return QString(); }
};
