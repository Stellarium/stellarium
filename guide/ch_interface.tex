...
\begin{figure}[tbp]
\centering\includegraphics[width=0.68\textwidth,trim=0 50 0 0,clip]{search_dialog_option.png}
...
sectin~\ref{sec:tour:markers}), select it and query SIMBAD ``tell me
