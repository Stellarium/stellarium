...
\item[Use designations for screen labels] --- when this option is
  ...
  added 3 additional items\footnote{All of these items work
    independently from the parent option.} --- \textbf{Dbl. stars},
  \textbf{Var. stars} and \textbf{HIP} --- which will append to the
  on-screen labels old designations of double stars, designations of
  variable stars and HIP designation respectively.
\end{description}
