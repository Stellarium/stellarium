...
%nebula\_scale & float & Sets how much to scale nebulae. a setting of \emph{1} will display nebulae at normal size. Default value: \emph{1.0}.\tabularnewline
%\midrule
%% GZ NOT USED
%flag\_bright\_nebulae & bool & Set to \emph{true} to increase nebulae brightness to enhance viewing (less realistic)\tabularnewline
%\midrule
%flag\_nebula\_ngc & bool & Enables/disables display of all NGC objects\tabularnewline
%\midrule
...
%% TODO: Make sure we can remove this note! 
