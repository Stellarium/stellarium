...
\noindent\newFeature{v0.16.1}Sometimes there is a need to extract some part of constellation in the own figure or merge parts from different constellations in one big figure --- e.g. ``Big Dipper'' for Ursa Major or ``Summer Triangle'' for constellations Cygnus, Lyra and Aquila. Those features names as ``asterisms'' as rule. The asterisms are listed in
...
\begin{configfile}
Abbr 1 pairs pair1_star1 pair1_star2 pair2_star1 pair2_star2 ...
\end{configfile}
or
\begin{configfile}
Abbr 2 pairs pair1_RA1 pair1_DE1 pair1_RA2 pair1_DE2 pair2_RA1 pair2_DE1 ...
\end{configfile}
In this file,
\begin{description}
\item[Abbr] is the abbreviation defined in \file{asterism\_names.eng.fab}
\item[type] is the type of asterism (1 for HIP numbers and 2 for coordinates)
\item[pairs] is the number of line pairs which follow.
\item[pairN\_starA] Hipparcos numbers for the stars which form the
  asterism stick figure (similar to constellations) or equatorial coordinates for epoch J2000.0 of the stars (decimal hours for right ascension and decimal degrees for declination). 
\end{description}
