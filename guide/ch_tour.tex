...
\key{\cmdmac+Q} on macOS.  For simplicity, we will show only the
...
The position of the toolbars can be changed to any of the four screen corners via the \menu{Toolbar location} drop-down in the
\menu{Configuration~\textrightarrow~Tools~\textrightarrow~Planetarium options} section.
\newFeature{26.3}
...
\begin{longtable}{p{40mm}ccp{54mm}}\toprule
...
Constellation Boundaries\footnote{\label{fn:activate-buttons}This button must be enabled first, see section~\ref{sec:gui:configuration:tools}} & \guibutton[0.75]{2.5}{bt_constellation_boundaries.png}& \key{B} & Draw boundaries of the constellations\\
Asterisms\textsuperscript{\ref{fn:activate-buttons}}                & \guibutton[0.75]{2.5}{btAsterismLines-off.png}     & \key{C} & Draw asterism ``stick figures'' \\
Asterism Names\textsuperscript{\ref{fn:activate-buttons}}           & \guibutton[0.75]{2.5}{btAsterismLabels-off.png}& \key{V} & Draw name of the asterisms \\
...
Galactic Grid\textsuperscript{\ref{fn:activate-buttons}}            & \guibutton[0.75]{2.5}{bt_gal_grid.png}          &         & Draw grid lines for the galactic coordinate system (Long/Lat)\\
Equatorial J2000 Grid\textsuperscript{\ref{fn:activate-buttons}}    & \guibutton[0.75]{2.5}{bt_eq_j2000_grid.png}     &         & Draw grid lines for the equatorial coordinate system at standard epoch J2000.0 (RA/Dec)\\
Ecliptic Grid\textsuperscript{\ref{fn:activate-buttons}}            & \guibutton[0.75]{2.5}{bt_ecl_grid.png}          &         & Draw grid lines for the ecliptic coordinate system of date (Long/Lat)\\
...
Toggle Compass Marks\textsuperscript{\ref{fn:activate-buttons}}     & \guibutton[0.75]{2.5}{bt_compass_off.png}       & \key{\shift+Q} & Toggle degree marks along the horizon. \\
...
Nebula images\textsuperscript{\ref{fn:activate-buttons}}            & \guibutton[0.75]{2.5}{bt_DSS.png}               & \key{I} & Toggle ``nebula images''.\\\
Digitized Sky Survey\textsuperscript{\ref{fn:activate-buttons}}     & \guibutton[0.75]{2.5}{bt_ToastSurvey.png}       &  & Toggle ``Digitized Sky Survey'' (TOAST).\\\
Hierarchical Progressive Surveys\textsuperscript{\ref{fn:activate-buttons}} & \guibutton[0.75]{2.5}{bt_Surveys.png}   & \key{\ctrl+Alt+D} & Toggle ``Hierarchical Progressive Surveys''.\\
...
Bookmarks\textsuperscript{\ref{fn:activate-buttons}}                & \guibutton[0.75]{2.5}{bt_bookmarks.png}         & \key{Alt+B} & Toggle bookmarks window.\\
Flip view (horizontal)\textsuperscript{\ref{fn:activate-buttons}}   & \guibutton[0.75]{2.5}{bt_fliph.png}      & \key{\ctrl+\shift+H} & Flip the image in the horizontal plane.\\
Flip view (vertical)\textsuperscript{\ref{fn:activate-buttons}}     & \guibutton[0.75]{2.5}{bt_flipv.png}      & \key{\ctrl+\shift+V} & Flip the image in the vertical plane.\\
...
View Window              & \guibutton[0.35]{2.5}{btd_view.png}       & \key{F4} & Show the view window \\
...
\bottomrule
\caption{Stellarium's standard menu buttons. Those marked \textsuperscript{\ref{fn:activate-buttons}} must be enabled first, see section~\ref{sec:gui:configuration:extras:buttons}.}
\label{tab:tour:buttons}
\end{longtable}

\section{Exporting data}
\label{sec:tour:export_data}
...
\label{sec:tour:export_data:scripting}

Stellarium is scriptable. You can write your own almanach with it. 
See chapter~\ref{ch:scripting} for details.
...
\label{ch:tour:speech}

Sometimes you may have\newFeature{25.4} dimmed down your field laptop or the font may be too small. 
Object information can also be output audibly by a Text-to-Speech engine. 
After object selection, press \key{Shift+R} to let a voice read ot to you. 
See section~\ref{sec:gui:configuration:speech} for details and configuration.
