...
public:	
	...
	virtual QString getName() const override { return "Historical Supernovae"; }
	virtual QString getStelObjectType() const override { return Supernova::SUPERNOVA_TYPE; }
