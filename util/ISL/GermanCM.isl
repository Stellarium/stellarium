; *** Inno Setup version 5.5.3+ German messages for Stellarium ***
;
...
RemoveUILandscapes=ACHTUNG! Lösche benutzer-installierte Landschaften
...
AngleD3D11Mode=(ANGLE Direct3D 11 Modus)
AngleWarpMode=(ANGLE WARP Modus)
MesaMode=(MESA-Modus)
DebugMode=(mit OpenGL Diagnostik)
SpoutMode=(mit Spout-Sender)
RedistRun=Installiere Microsofts C/C++ Runtime...
DeleteUserData=ACHTUNG: Benutzerdaten löschen (Stellarium-Einstellungen, Landschaften, 3D-Szenerien und andere eigene Stellarium-Daten)? NEIN um sie beizubehalten.
