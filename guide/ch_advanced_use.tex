...
Apart from stand-alone use, Stellarium can be part of larger installations, in museums or science exhibitions. 
...
the \texttt{--spout=sky} command line option. Currently \program{Spout} output is limited to the main window without GUI panels. 
Your master application must embed a \program{Spout} receiver.

This mode does not work in ANGLE mode and requires modern graphics hardware running in OpenGL mode.  
