...
public:
	NomenclatureMgr();
	virtual ~NomenclatureMgr() override;

	///////////////////////////////////////////////////////////////////////////
	// Methods defined in the StelModule class
	virtual void init() override;
	virtual void deinit() override;
	virtual void update(double deltaTime) override {NomenclatureItem::labelsFader.update(static_cast<int>(deltaTime*1000));}
	...
	virtual StelObjectP searchByID(const QString &id) const override { return qSharedPointerCast<StelObject>(searchByEnglishName(id)); }
	...
	virtual QString getName() const override { return "Geological features"; }
	virtual QString getStelObjectType() const override { return NomenclatureItem::NOMENCLATURE_TYPE; }
