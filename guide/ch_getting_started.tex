...
Similar to an \emph{AppImage} packages you may use \emph{flat}\footnote{\url{https://flathub.org/apps/details/org.stellarium.Stellarium}} and \emph{snap}\footnote{\url{https://snapcraft.io/stellarium-daily}} packages also.
