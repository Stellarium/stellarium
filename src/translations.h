...
class Translations
{
	...
	static translationList()
	{
		...
		N_("Messier Marathon on March 20, 2020. The data for the script are taken from GaoXing's observation log (now defunct): http://www.xjltp.com/2_huodong/2_030301.htm. Missing descriptions added by Nicolas Martignoni.");
