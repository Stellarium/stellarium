...
\begin{figure}[h]
\centering\includegraphics[width=0.68\textwidth]{search_dialog_simbad.png}
...
The SIMBAD tab (Fig.~\ref{fig:gui:search:simbad}) provides a convenient way to fetch and show a set of information for selected object from astronomical database SIMBAD\cite{2000A&AS..143....9W}.
