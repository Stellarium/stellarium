...
\midrule
default\_color           				& 0.5,0.5,0.7 & \colorbox[rgb]{0.5,0.5,0.7}{\makebox(26,8){}} & default colour.\\\midrule
azimuthal\_color         				& 0.3,0.2,0.1 & \colorbox[rgb]{0.3,0.2,0.1}{\makebox(26,8){}} &  azimuthal grid. \\\midrule
equatorial\_color        				& 0.2,0.3,0.8 & \colorbox[rgb]{0.2,0.3,0.8}{\makebox(26,8){}} &  equatorial grid (of date). \\\midrule
equatorial\_J2000\_color 				& 0.1,0.1,0.5 & \colorbox[rgb]{0.1,0.1,0.5}{\makebox(26,8){}} &  equatorial grid (J2000). \\\midrule
ecliptical\_color        				& 0.6,0.3,0.1 & \colorbox[rgb]{0.6,0.3,0.1}{\makebox(26,8){}} &  ecliptical grid (of date). \\\midrule
ecliptical\_J2000\_color 				& 0.4,0.1,0.1 & \colorbox[rgb]{0.4,0.1,0.1}{\makebox(26,8){}} &  ecliptical grid (J2000). \\\midrule
galactic\_color          				& 0.0,0.3,0.2 & \colorbox[rgb]{0.0,0.3,0.2}{\makebox(26,8){}} &  galactic grid. \\\midrule
galactic\_equator\_color 				& 0.5,0.3,0.1 & \colorbox[rgb]{0.5,0.3,0.1}{\makebox(26,8){}} &  galactic equator line. \\\midrule
equator\_color           				& 0.3,0.5,1.0 & \colorbox[rgb]{0.3,0.5,1.0}{\makebox(26,8){}} &  equatorial line. \\\midrule
ecliptic\_color          				& 0.9,0.6,0.2 & \colorbox[rgb]{0.9,0.6,0.2}{\makebox(26,8){}} &  ecliptic line (of date). \\\midrule
ecliptic\_J2000\_color   				& 0.7,0.2,0.2 & \colorbox[rgb]{0.7,0.2,0.2}{\makebox(26,8){}} &  ecliptic grid (J2000). \\\midrule
meridian\_color          				& 0.2,0.6,0.2 & \colorbox[rgb]{0.2,0.6,0.2}{\makebox(26,8){}} &  meridian line. \\\midrule
horizon\_color           				& 0.2,0.6,0.2 & \colorbox[rgb]{0.2,0.6,0.2}{\makebox(26,8){}} &  horizon line. \\\midrule
const\_lines\_color      				& 0.2,0.2,0.6 & \colorbox[rgb]{0.2,0.2,0.6}{\makebox(26,8){}} &  constellation lines. \\\midrule
const\_names\_color      				& 0.4,0.6,0.9 & \colorbox[rgb]{0.4,0.6,0.9}{\makebox(26,8){}} &  constellation names. \\\midrule
const\_boundary\_color   				& 0.3,0.1,0.1 & \colorbox[rgb]{0.3,0.1,0.1}{\makebox(26,8){}} &  constellation boundaries. \\\midrule
star\_label\_color       				& 0.4,0.3,0.5 & \colorbox[rgb]{0.4,0.3,0.5}{\makebox(26,8){}} &  star labels. \\\midrule
cardinal\_color          				& 0.8,0.2,0.1 & \colorbox[rgb]{0.8,0.2,0.1}{\makebox(26,8){}} &  cardinal points. \\\midrule
planet\_names\_color     				& 0.5,0.5,0.7 & \colorbox[rgb]{0.5,0.5,0.7}{\makebox(26,8){}} &  planet names. \\\midrule
planet\_orbits\_color    				& 0.7,0.2,0.2 & \colorbox[rgb]{0.7,0.2,0.2}{\makebox(26,8){}} &  orbits. \\\midrule
planet\_pointers\_color  				& 1.0,0.3,0.3 & \colorbox[rgb]{1.0,0.3,0.3}{\makebox(26,8){}} &  planet pointers. \\\midrule
object\_trails\_color    				& 1.0,0.7,0.0 & \colorbox[rgb]{1.0,0.7,0.0}{\makebox(26,8){}} &  planet trails. \\\midrule
precession\_circles\_color 				& 0.9,0.6,0.2 & \colorbox[rgb]{0.9,0.6,0.2}{\makebox(26,8){}} &  precession circles. \\\midrule
prime\_vertical\_color   				& 0.18,0.54,0.18 & \colorbox[rgb]{0.18,0.54,0.18}{\makebox(26,8){}} &  prime vertical. \\\midrule
longitude\_color	     				& 0.2,0.4,0.4 & \colorbox[rgb]{0.2,0.4,0.4}{\makebox(26,8){}} &  opposition/conjunction longitude. \\\midrule
circumpolar\_circles\_color 			& 0.5,0.5,0.7 & \colorbox[rgb]{0.5,0.5,0.7}{\makebox(26,8){}} &  circumpolar circles. \\\midrule
colures\_color 			 				& 0.5,0.5,0.7 & \colorbox[rgb]{0.5,0.5,0.7}{\makebox(26,8){}} &  colures. \\\midrule
telescope\_circle\_color 				& 0.6,0.4,0.0 & \colorbox[rgb]{0.6,0.4,0.0}{\makebox(26,8){}} &  telescope location indicator. \\\midrule
telescope\_label\_color  				& 0.6,0.4,0.0 & \colorbox[rgb]{0.6,0.4,0.0}{\makebox(26,8){}} &  telescope label (next to location circle). \\\midrule
script\_console\_keyword\_color  		& 1.0,0.0,1.0 & \colorbox[rgb]{1.0,0.0,1.0}{\makebox(26,8){}} & syntax highlight for keywords in the script console. \\\midrule
script\_console\_module\_color   		& 0.0,1.0,1.0 & \colorbox[rgb]{0.0,1.0,1.0}{\makebox(26,8){}} & syntax highlight for modules in the script console. \\\midrule
script\_console\_comment\_color  		& 1.0,1.0,0.0 & \colorbox[rgb]{1.0,1.0,0.0}{\makebox(26,8){}} & syntax highlight for comments in the script console. \\\midrule
script\_console\_function\_color 		& 0.0,1.0,0.0 & \colorbox[rgb]{0.0,1.0,0.0}{\makebox(26,8){}} & syntax highlight for functions in the script console. \\\midrule
script\_console\_constant\_color 		& 1.0,0.5,0.5 & \colorbox[rgb]{1.0,0.5,0.5}{\makebox(26,8){}} & syntax highlight for constants in the script console. \\\midrule
daylight\_text\_color            		& 0.0,0.0,0.0 & \colorbox[rgb]{0.0,0.0,0.0}{\makebox(26,8){}} & info text at daylight. \\\midrule
dso\_label\_color                       & 0.2,0.6,0.7 & \colorbox[rgb]{0.2,0.6,0.7}{\makebox(26,8){}} & deep-sky objects labels. \\\midrule
dso\_circle\_color                      & 1.0,0.7,0.2 & \colorbox[rgb]{1.0,0.7,0.2}{\makebox(26,8){}} & deep-sky objects symbols, if not of the types below. \\\midrule
dso\_galaxy\_color                      & 1.0,0.2,0.2 & \colorbox[rgb]{1.0,0.2,0.2}{\makebox(26,8){}} & galaxies symbols. \\\midrule
dso\_radio\_galaxy\_color               & 0.3,0.3,0.3 & \colorbox[rgb]{0.3,0.3,0.3}{\makebox(26,8){}} & radio galaxies symbols. \\\midrule
dso\_active\_galaxy\_color              & 1.0,0.5,0.2 & \colorbox[rgb]{1.0,0.5,0.2}{\makebox(26,8){}} & active galaxies symbols. \\\midrule
dso\_interacting\_galaxy\_color         & 0.2,0.5,1.0 & \colorbox[rgb]{0.2,0.5,1.0}{\makebox(26,8){}} & interacting galaxies symbols. \\\midrule
dso\_quasar\_color                      & 1.0,0.2,0.2 & \colorbox[rgb]{1.0,0.2,0.2}{\makebox(26,8){}} & quasars symbols. \\\midrule
dso\_possible\_quasar\_color            & 1.0,0.2,0.2 & \colorbox[rgb]{1.0,0.2,0.2}{\makebox(26,8){}} & possible quasars symbols. \\\midrule
dso\_bl\_lac\_color                     & 1.0,0.2,0.2 & \colorbox[rgb]{1.0,0.2,0.2}{\makebox(26,8){}} & BL Lac objects symbols. \\\midrule
dso\_blazar\_color                      & 1.0,0.2,0.2 & \colorbox[rgb]{1.0,0.2,0.2}{\makebox(26,8){}} & blazars symbols. \\\midrule
dso\_nebula\_color                      & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & nebulae symbols. \\\midrule
dso\_planetary\_nebula\_color           & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & planetary nebulae symbols. \\\midrule
dso\_reflection\_nebula\_color          & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & reflection nebulae symbols. \\\midrule
dso\_bipolar\_nebula\_color             & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & bipolar nebulae symbols. \\\midrule
dso\_emission\_nebula\_color            & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & emission nebulae symbols. \\\midrule
dso\_dark\_nebula\_color                & 0.3,0.3,0.3 & \colorbox[rgb]{0.3,0.3,0.3}{\makebox(26,8){}} & dark nebulae symbols. \\\midrule
dso\_hydrogen\_region\_color            & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & hydrogen regions symbols. \\\midrule
dso\_supernova\_remnant\_color          & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & supernovae remnants symbols. \\\midrule
dso\_interstellar\_matter\_color        & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & interstellar matter symbols. \\\midrule
dso\_cluster\_with\_nebulosity\_color   & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & clusters associated with nebulosity symbols. \\\midrule
dso\_molecular\_cloud\_color            & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & molecular clouds symbols. \\\midrule
dso\_possible\_planetary\_nebula\_color & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & possible planetary nebulae symbols. \\\midrule
dso\_protoplanetary\_nebula\_color      & 0.1,1.0,0.1 & \colorbox[rgb]{0.1,1.0,0.1}{\makebox(26,8){}} & protoplanetary nebulae symbols. \\\midrule
dso\_cluster\_color                     & 1.0,1.0,0.1 & \colorbox[rgb]{1.0,1.0,0.1}{\makebox(26,8){}} & star clusters symbols. \\\midrule
dso\_open\_cluster\_color               & 1.0,1.0,0.1 & \colorbox[rgb]{1.0,1.0,0.1}{\makebox(26,8){}} & open star clusters symbols. \\\midrule
dso\_globular\_cluster\_color           & 1.0,1.0,0.1 & \colorbox[rgb]{1.0,1.0,0.1}{\makebox(26,8){}} & globular star clusters symbols. \\\midrule
dso\_stellar\_association\_color        & 1.0,1.0,0.1 & \colorbox[rgb]{1.0,1.0,0.1}{\makebox(26,8){}} & stellar associations symbols. \\\midrule
dso\_star\_cloud\_color                 & 1.0,1.0,0.1 & \colorbox[rgb]{1.0,1.0,0.1}{\makebox(26,8){}} & star clouds symbols. \\\midrule
dso\_star\_color                        & 1.0,0.7,0.2 & \colorbox[rgb]{1.0,0.7,0.2}{\makebox(26,8){}} & star symbols. \\\midrule
dso\_emission\_object\_color            & 1.0,0.7,0.2 & \colorbox[rgb]{1.0,0.7,0.2}{\makebox(26,8){}} & emission objects symbols. \\\midrule
dso\_young\_stellar\_object\_color      & 1.0,0.7,0.2 & \colorbox[rgb]{1.0,0.7,0.2}{\makebox(26,8){}} & young stellar objects symbols. \\
\bottomrule
\end{longtabu}
