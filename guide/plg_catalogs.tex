...
\begin{description}
	...
	\item[French] --- the 81 stars that are listed in the \emph{Ephémérides Nautiques} published by the French Bureau des Longitudes.
		\item[German] --- the 80 stars that are listed in the \emph{Nautisches Jahrbuch} published by the Federal Maritime and Hydrographic Agency of Germany (Bundesamt für Seeschifffahrt und Hydrographie).
