...
You can set \newFeature{v0.21.1} geographical coordinates and a name
...
altitudes, and declinations. \newFeature{v0.15.1, v0.21.1}  Note that these azimuths are always counted
...
pressing the \guibutton[0.25]{2}{telescope_blk.png} button.
