...
void StelCore::init()
{
	...
	actionsMgr->addAction("actionIncrease_Time_Speed", "DateAndTime", N_("Increase time speed"), this, "increaseTimeSpeed()", "L");
	actionsMgr->addAction("actionDecrease_Time_Speed", "DateAndTime", N_("Decrease time speed"), this, "decreaseTimeSpeed()", "J");
	actionsMgr->addAction("actionIncrease_Time_Speed_Less", "DateAndTime", N_("Increase time speed (a little)"), this, "increaseTimeSpeedLess()", "Shift+L");
	actionsMgr->addAction("actionDecrease_Time_Speed_Less", "DateAndTime", N_("Decrease time speed (a little)"), this, "decreaseTimeSpeedLess()", "Shift+J");
	actionsMgr->addAction("actionSet_Real_Time_Speed", "DateAndTime", N_("Set normal time rate"), this, "toggleRealTimeSpeed()", "K");
	actionsMgr->addAction("actionSet_Time_Rate_Zero", "DateAndTime", N_("Set time rate to zero"), this, "setZeroTimeSpeed()", "7");
	actionsMgr->addAction("actionReturn_To_Current_Time", "DateAndTime", N_("Set time to now"), this, "setTimeNow()", "8");
	actionsMgr->addAction("actionAdd_Solar_Hour", "DateAndTime", N_("Add 1 solar hour"), this, "addHour()", "Ctrl+=");
	...
	actionsMgr->addAction("actionSubtract_Solar_Hour", "DateAndTime", N_("Subtract 1 solar hour"), this, "subtractHour()", "Ctrl+-");
	...
	actionsMgr->addAction("actionAdd_Sidereal_Day", "DateAndTime", N_("Add 1 sidereal day"), this, "addSiderealDay()", "Alt+=");
	actionsMgr->addAction("actionAdd_Sidereal_Week", "DateAndTime", N_("Add 1 sidereal week"), this, "addSiderealWeek()", "Alt+]");
	actionsMgr->addAction("actionAdd_Sidereal_Month", "DateAndTime", N_("Add 1 sidereal month"), this, "addSiderealMonth()", "Alt+Shift+]");
	actionsMgr->addAction("actionAdd_Sidereal_Year", "DateAndTime", N_("Add 1 sidereal year"), this, "addSiderealYear()", "Ctrl+Alt+Shift+]");
	...
	actionsMgr->addAction("actionSubtract_Sidereal_Day", "DateAndTime", N_("Subtract 1 sidereal day"), this, "subtractSiderealDay()", "Alt+-");
	actionsMgr->addAction("actionSubtract_Sidereal_Week", "DateAndTime", N_("Subtract 1 sidereal week"), this, "subtractSiderealWeek()", "Alt+[");
	actionsMgr->addAction("actionSubtract_Sidereal_Month", "DateAndTime", N_("Subtract 1 sidereal month"), this, "subtractSiderealMonth()", "Alt+Shift+[");
	actionsMgr->addAction("actionSubtract_Sidereal_Year", "DateAndTime", N_("Subtract 1 sidereal year"), this, "subtractSiderealYear()", "Ctrl+Alt+Shift+[");
	...
	actionsMgr->addAction("actionSet_Home_Planet_To_Selected", "MovementAndSelection", N_("Set home planet to selected planet"), this, "moveObserverToSelected()", "Ctrl+G");
	actionsMgr->addAction("actionGo_Home_Global", "MovementAndSelection", N_("Go to home"), this, "returnToHome()", "Ctrl+H");
	actionsMgr->addAction("actionHorizontal_Flip", "Display Options", N_("Flip scene horizontally"), this, "flipHorz", "Ctrl+Shift+H", "", true);
	actionsMgr->addAction("actionVertical_Flip", "Display Options", N_("Flip scene vertically"), this, "flipVert", "Ctrl+Shift+V", "", true);
