...
public:
	...
	bool addTelescopeAtSlot(int slot, QString name, QString host, int portTCP, int delay, bool connectAtStartup, QList<double> circles, QString serverName = QString(), QString portSerial = QString());
	...
	bool getTelescopeAtSlot(int slot, QString& name, QString& host, int& portTCP, int& delay, bool& connectAtStartup, QList<double>& circles, QString& serverName, QString& portSerial);
...
private:
	...
	bool startClientAtSlot(int slot, QString name, QString host, int portTCP, int delay, QList<double> circles, QString serverName = QString(), QString portSerial = QString());
