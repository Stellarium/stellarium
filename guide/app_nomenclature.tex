...
\end{itemize}
File \file{data/nomenclature.dat} is a zipped \file{data/nomenclature.fab} file and used to minimize loading the data and reduce size of the installation package.
