...
void ExoplanetsDialog::setInfoHtml(void)
{
	...
	html += QString("<li><strong>%1</strong> (%2) &mdash; %3.</li>").arg(trans.qtranslate("Poltergeist"), "PSR B1257+12 c", q_("Poltergeist is an name for supernatural beings that create physical disturbances, from German for <em>noisy ghost</em>."));
