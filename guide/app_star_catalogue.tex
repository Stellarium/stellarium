...
\file{stars/hip\_gaia3/}\allowbreak\file{object\_types\_v0\_1.cat} works as-is. The
spectral type table \file{stars\_hip\_sp\_0v0\_6.cat} is optional input
...
\begin{description}
  ...
  \item[\program{--stars-config}] path to the Stellarium
        ...
        (\texttt{\%APPDATA\%\textbackslash Stellarium\textbackslash}\allowbreak
        \texttt{stars\textbackslash hip\_gaia3\textbackslash starsConfig.json}
