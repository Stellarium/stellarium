...
namespace Ui {
class TelescopeClientAlpacaWidget;
}

class TelescopeClientAlpacaWidget : public QWidget
{
	Q_OBJECT

public:
	explicit TelescopeClientAlpacaWidget(QWidget *parent = nullptr);
	~TelescopeClientAlpacaWidget() override;
...
private:
	Ui::TelescopeClientAlpacaWidget *ui;
	AlpacaDevice *Alpaca;
	QString mSelectedDevice = nullptr;
};

#endif // TELESCOPECLIENTASCOMWIDGET_HPP
