...
In this section you can fine-tune 10 predefined values of field of view in degrees (all FOV may be set through keyboard hotkeys).

\noindent%
\begin{tabularx}{\textwidth}{l|l|l|X}\toprule
\emph{ID} & \emph{Type} & \emph{Default} & \emph{Description}\\\midrule
quick\_fov\_0 & float & 0.5  & predefined value for FOV \emph{0}.\\%\midrule
quick\_fov\_1 & float & 180  & predefined value for FOV \emph{1}.\\%\midrule
quick\_fov\_2 & float & 90   & predefined value for FOV \emph{2}.\\%\midrule
quick\_fov\_3 & float & 60   & predefined value for FOV \emph{3}.\\%\midrule
quick\_fov\_4 & float & 45   & predefined value for FOV \emph{4}.\\%\midrule
quick\_fov\_5 & float & 20   & predefined value for FOV \emph{5}.\\%\midrule
quick\_fov\_6 & float & 10   & predefined value for FOV \emph{6}.\\%\midrule
quick\_fov\_7 & float & 5    & predefined value for FOV \emph{7}.\\%\midrule
quick\_fov\_8 & float & 2    & predefined value for FOV \emph{8}.\\%\midrule
quick\_fov\_9 & float & 1    & predefined value for FOV \emph{9}.  \\\bottomrule
\end{tabularx}
...
\midrule
flag\_fov\_center\_marker        & bool  & Set to \emph{true} to enable drawing a center of field of view marker \\
flag\_fov\_circular\_marker      & bool  & Set to \emph{true} to enable drawing the circular FOV marker \\
size\_fov\_circular\_marker      & float & size of the circular FOV marker, degrees \\
flag\_fov\_rectangular\_marker   & bool  & Set to \emph{true} to enable drawing the rectangular FOV marker \\
...
flag\_compass\_marks             & bool  & Set to \emph{true} to enable drawing a compass marks \\
\midrule
