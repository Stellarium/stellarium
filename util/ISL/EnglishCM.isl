...
ForCurrentUserOnly=For the current user only
RemoveFromPreviousInstallation=Remove files left over from a previous installation:
RemoveInstallationData=Remove files left over from a installation:
RemoveMainConfig=Remove the main configuration file
RemovePluginsConfig=Remove plug-ins' configuration files
RemoveSolarConfig=Remove Solar System file
RemoveUILandscapes=ATTENTION! Remove user-installed landscapes
RemoveShortcutsConfig=Remove shortcuts' configuration file
RemoveCache=Remove cache files
RemoveUserAppData=Remove data from Application Data directory
RemoveLocalAppData=Remove data from local Application Data directory
