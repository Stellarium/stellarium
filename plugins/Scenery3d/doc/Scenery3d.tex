...
\url{http://www.kerkythea.net/joomla/}}.  You need \filename{SU2KT~3.17}
or better, and \filename{KT2OBJ~1.1.0}\footnote{\url{http://www.nicetuna.com/kt2obj}} or better.  
During export, Sketchup's layout window would be constantly updated, wasting time. So at least mimimize this window.
Deselect any selection, then
