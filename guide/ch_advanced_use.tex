...
from Stellarium's Github website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.9}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.9; extended edition & \file{catalog.dat} &\texttt{06bef36c980c6e0088f3dcecee3947b7}& 27MB\\\bottomrule
\end{tabular}
