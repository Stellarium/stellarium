...
void ZoroastrianCalendar::retranslate()
{
	...
	monthNames={
		{ 1, qc_("Ferwerdin"     , "Zoroastrian month name")}, // FIXME: FIND NAMES!
		{ 2, qc_("Ardebehesht"   , "Zoroastrian month name")},
		{ 3, qc_("Khordad"       , "Zoroastrian month name")},
		{ 4, qc_("Tir"           , "Zoroastrian month name")},
		{ 5, qc_("Mordad"        , "Zoroastrian month name")},
		{ 6, qc_("Sharir"        , "Zoroastrian month name")},
		{ 7, qc_("Mihr"          , "Zoroastrian month name")},
		{ 8, qc_("Aban"          , "Zoroastrian month name")},
		{ 9, qc_("Ader"          , "Zoroastrian month name")},
		{10, qc_("Dei"           , "Zoroastrian month name")},
		{11, qc_("Bahmen"        , "Zoroastrian month name")},
		{12, qc_("Asfendarmed"   , "Zoroastrian month name")},
		{13, qc_("(epagomenae)"  , "Zoroastrian month name")}};
	dayNames={
		{ 1, qc_("Hormuz"      , "Zoroastrian day name")},
		{ 2, qc_("Bahman"      , "Zoroastrian day name")},
		{ 3, qc_("Ordibehesht" , "Zoroastrian day name")},
		{ 4, qc_("Shahrivar"   , "Zoroastrian day name")},
		{ 5, qc_("Esfandarmud" , "Zoroastrian day name")},
		{ 6, qc_("Xordad"      , "Zoroastrian day name")},
		{ 7, qc_("Mordad"      , "Zoroastrian day name")},
		{ 8, qc_("Diy be Azar" , "Zoroastrian day name")},
		{ 9, qc_("Azar"        , "Zoroastrian day name")},
		{10, qc_("Aban"        , "Zoroastrian day name")},
		{11, qc_("Xor"         , "Zoroastrian day name")},
		{12, qc_("Mah"         , "Zoroastrian day name")},
		{13, qc_("Tir"         , "Zoroastrian day name")},
		{14, qc_("Goosh"       , "Zoroastrian day name")},
		{15, qc_("Diy be Mehr" , "Zoroastrian day name")},
		{16, qc_("Mehr"        , "Zoroastrian day name")},
		{17, qc_("Sorush"      , "Zoroastrian day name")},
		{18, qc_("Rashn"       , "Zoroastrian day name")},
		{19, qc_("Farvardin"   , "Zoroastrian day name")},
		{20, qc_("Bahram"      , "Zoroastrian day name")},
		{21, qc_("Ram"         , "Zoroastrian day name")},
		{22, qc_("Bad"         , "Zoroastrian day name")},
		{23, qc_("Diy be Din"  , "Zoroastrian day name")},
		{24, qc_("Din"         , "Zoroastrian day name")},
		{25, qc_("Ard"         , "Zoroastrian day name")},
		{26, qc_("Ashtad"      , "Zoroastrian day name")},
		{27, qc_("Asman"       , "Zoroastrian day name")},
		{28, qc_("Zamyad"      , "Zoroastrian day name")},
		{29, qc_("Maresfand"   , "Zoroastrian day name")},
		{30, qc_("Aniran"      , "Zoroastrian day name")}};
	epagomenaeNames={
		{ 1, qc_("Ahnad"       , "Zoroastrian day name")},
		{ 2, qc_("Ashnad"      , "Zoroastrian day name")},
		{ 3, qc_("Esfandarmud" , "Zoroastrian day name")},
