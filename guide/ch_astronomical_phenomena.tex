...
\indexterm{osculating orbital elements}, which describe the motions on
...
need to have valid (current) \indexterm{orbital elements}. See
...
\caption{Contact terminology for Lunar eclipses. Depending on shadow
  gemetry, the second penumbral contact may occur only after the first
