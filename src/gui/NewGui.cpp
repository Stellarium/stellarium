...
void NewGui::glWindowHasBeenResized(int ww, int hh)
{
	...
	buttonBar->setPos(buttonBarPath->getRoundSize(), h-buttonBar->boundingRect().height()-buttonBarPath->getRoundSize()+1.5+(1.-animBottomBarTimeLine->currentValue())*rangeY);
