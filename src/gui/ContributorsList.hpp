...
namespace StelContributors {
    ...
    static const QStringList contributorsList =
    {
        ...
        "Shantanu Agarwal", "Nick Kanel", "colossatr0n", "luzpaz", "Martin Bernardi", 
        "Miroslav Broz", "ysjbserver", "Alexandros Kosiaris", "Alexey Dokuchaev", "Aspere", 
        "Clement Sommelet", "Colin Gaudion", "Daniel", "David Baucum", "EuklidAlexandria", 
        "Felix Z", "Freeman Li", "Hans Lambermont", "Jocelyn GIROD", "Kirill Snezhko", 
        "Konrad Rybka", "Maciej Serylak", "Max Digruber", "Norman Rasmussen", "Peter Neubauer", 
        "Robert S. Fuller", "Sergey", "Steven Bellavia", "Victor Reijs", "bv6679", 
        "Daniel Adastra", "sebagr", "tofilwiktor", "Adam Majer", "Alec Clews", 
