...
\begin{figure}[ht]
\includegraphics[width=\textwidth]{sn1604wiki}
...
\begin{figure}[h]
\includegraphics[width=\textwidth]{exoplanets}
...
In December 2015, the International Astronomical Union (IAU)\index{IAU} has officially approved names for several exoplanets after a public vote.
\begin{description}
...
\item[Janssen] (55 Cnc e) -- \name[Jacharias]{Janssen} (1580s-1630s) was a Dutch spectacle maker who is often attributed with invention of the microscope, and more controversially with the invention of the telescope.
...
\\\midrule
temperature\_scale & string & Temperature scale for equilibrium temperature of exoplanets. Possible values: \emph{Kelvin}, \emph{Celsius}, \emph{Fahrenheit}. Default value: \emph{Celsius}. \\\bottomrule
\end{longtabu}
