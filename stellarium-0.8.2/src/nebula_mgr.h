...
public:
    ...
    void setFlagShowNebula(bool b);
    void setNebulaFadeDurationCoefficient(float cf);
    void setFlagShow(bool b) { flagShow = b; setFlagShowNebula(b); }
	static bool getFlagShow(void) { return flagShow; }
