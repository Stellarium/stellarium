...
\item[New Hindu Solar and Lunisolar] This is the classical Hindu
  ...
  month is ``leap'' and named after the following month. When a Solar
  month elapses without a New Moon, a lunar month can also be skipped
  (\emph{kshaya}).
  The Lunisolar year has 12 or 13 months, of which up to 2 can be leap
  and one skipped. Both months schemes share the same 12 names.
