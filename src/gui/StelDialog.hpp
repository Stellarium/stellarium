...
protected:
   ...
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectCheckBox(QAbstractButton* checkBox,const QString& actionName);
	//! Helper function to connect a checkbox to the given StelAction
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectCheckBox(QAbstractButton *checkBox, StelAction* action);
   ...
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectIntProperty(QLineEdit* lineEdit, const QString& propName);
	//! Helper function to connect a QSpinBox to an integer StelProperty.
	//! @note This method also works with flag/enum types
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectIntProperty(QSpinBox* spinBox, const QString& propName);
	...
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectIntProperty(QComboBox* comboBox, const QString& propName);
	...
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectIntProperty(QSlider* slider, const QString& propName, int minValue, int maxValue);
	//! Helper function to connect a QDoubleSpinBox to an double or float StelProperty
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectDoubleProperty(QDoubleSpinBox* spinBox, const QString& propName);
	//! Helper function to connect an AngleSpinBox to a double or float StelProperty representing decimal degrees
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectDoubleProperty(AngleSpinBox* spinBox, const QString& propName);
	//! Helper function to connect a QSlider to an double or float StelProperty
	//! @param slider The slider which should be connected
	//! @param propName The id of the StelProperty which should be connected
	...
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectDoubleProperty(QSlider* slider, const QString& propName, double minValue, double maxValue);
	...
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectStringProperty(QComboBox *comboBox, const QString &propName);
	//! Helper function to connect a QLineEdit to a QString StelProperty.
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectStringProperty(QLineEdit *lineEdit, const QString &propName);

	//! Helper function to connect a checkbox to a bool StelProperty
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectBoolProperty(QAbstractButton* checkBox, const QString& propName);
	//! Helper function to connect a groupbox to a bool StelProperty
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") static void connectBoolProperty(QGroupBox *checkBox, const QString &propName);
	...
	//! @warning If the action with \c propName is invalid/unregistered, or cannot be converted
	//! to the required datatype, the application will crash
   Q_DECL_DEPRECATED_X("Do not use; prevents compile-time error checking!") void connectColorButton(QToolButton* button, QString propertyName, QString iniName, QString moduleName="");
