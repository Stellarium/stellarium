...
\emph{Column} & \emph{Type} & \emph{Description}\\\midrule
 ...
 4 & float   & B magnitude\\
 5 & float   & V magnitude\\
 6 & string  & Object type (See table  Types of Objects below).\\
...
this are The Gimp\footnote{free in keeping with the Stellarium spirit; available from \url{http://www.gimp.org}} or
...
\caption{Stellarium Textures Generator: A program to convert Equatorial coordinates into decimal
...
\caption{ReadDSS: A program to write a \file{textures.json} insert with epoch manipulation.}
