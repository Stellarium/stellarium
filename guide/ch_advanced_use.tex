...
\noindent\newFeature{v0.16.1}Stellarium is packaged with over 90 thousand deep-sky 
...
from Stellarium's SourceForge website\footnote{\url{https://sourceforge.net/projects/stellarium/files/Extra-data-files/DSO/3.3/}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version}&\emph{Filename}& \emph{MD5 hash}& \emph{Size}\\\midrule
3.3; extended edition & \file{catalog.dat} &\texttt{b703354655d7d7f109f2ed97100b8de5}& 28.6\,MB\\\bottomrule
\end{tabular}
