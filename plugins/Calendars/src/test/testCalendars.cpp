...
void TestCalendars::testMesoamerican()
{
	...
	QVERIFY2(Calendar::fixedFromJD(584282.5, false) == JulianCalendar::fixedFromJulian({-3114, 9, 6}),
		 qPrintable(QString("fixedFromJD %1 vs fixedFromJulian %2")
			    ...
			    .arg(JulianCalendar::fixedFromJulian({-3114, 9, 6}))  ));
	QVERIFY2(MayaLongCountCalendar::fixedFromMayanLongCount({0, 0, 0, 0, 0}) == GregorianCalendar::fixedFromGregorian({-3113, 8, 11}),
	...
	QVERIFY(MayaTzolkinCalendar::mayanTzolkinFromFixed(MayaLongCountCalendar::fixedFromMayanLongCount({0, 0, 0, 0, 0})) == QVector<int>({4, 20}));
