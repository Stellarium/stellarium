...
flag\_star\_designation\_dbl\_stars  & bool & false & If \emph{true}, and star doesn't have common name and Bayer or Flamesteed designations then use first of traditional designations of double stars to the on-screen labels.\\
flag\_star\_designation\_var\_stars  & bool & false & If \emph{true}, and star doesn't have common name and Bayer, Flamesteed and traditional for double stars designations then add the designation of variable stars to the on-screen labels.\\
flag\_star\_designation\_hip       & bool   & false & If \emph{true}, use HIP designations of stars to the on-screen labels if common name or traditional designations are not exist for star.\\\midrule
%
