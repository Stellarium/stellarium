...
\begin{figure}[p]
\centering\includegraphics[width=0.85\textwidth]{astrocalc_dialog_eclipses_lse.jpg}
...
\begin{figure}[p]
\centering\includegraphics[width=0.85\textwidth]{astrocalc_dialog_eclipses_le.jpg}
\caption{Astronomical Calculations (AstroCalc): Eclipses / Lunar Eclipses}
\label{fig:gui:AstroCalc:Eclipses:LunarEclipses}
\end{figure}

\begin{figure}[p]
\centering\includegraphics[width=0.85\textwidth]{astrocalc_dialog_transits.jpg}
...
\begin{figure}[htp]
\centering\includegraphics[width=0.625\textwidth]{help_dialog.png}
\caption{Help Window}
\label{fig:gui:help}
\end{figure}
