...
in the \emph{Tools} tab of the \emph{Configuration} dialog (\guibutton[0.25]{2}{btd_config} or
\key{F2}).
...
but an extended DSO catalog with over one million objects (up to $19.0^m$) may be downloaded
from Stellarium's SourceForge website\footnote{\url{https://sourceforge.net/projects/stellarium/files/Extra-data-files/DSO/3.1/}}:
...
Please az least compare with JPL Horizons\footnote{\url{https://ssd.jpl.nasa.gov/horizons.cgi}} for dependable results.
