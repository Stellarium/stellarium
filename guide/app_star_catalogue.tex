...
\begin{description}
  ...
  \item[\program{--erfa-python}] a Python interpreter with astropy
        installed. If given, the $\pm$210\,kyr past/future analysis that
...
\file{util/gaiacat/}) performs a global (cross-zone) match of two catalogue
sets at levels~0--3 and classifies \emph{every} differing star by the
physical field that exceeds tolerance:
