...
program download (the standard edition of Stellarium DSO catalog --- see section \ref{sec:dso:catalog}), but the larger catalog with over one million objects (the extended edition of Stellarium DSO catalog) may be downloaded
