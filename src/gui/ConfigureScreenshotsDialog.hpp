...
#ifndef CONFIGURESCREENSHOTSDIALOG_HPP
...
class Ui_configureScreenshotsDialogForm;

//! @class ConfigureScreenshotsDialog
class ConfigureScreenshotsDialog : public StelDialog
{
	Q_OBJECT

public:
	ConfigureScreenshotsDialog();
	virtual ~ConfigureScreenshotsDialog() Q_DECL_OVERRIDE;
