...
LinearFader NebulaMgr::flagShow;
...
void NebulaMgr::setNebulaFadeDurationCoefficient(float cf) {Nebula::fadeCoefficient = cf;}
void NebulaMgr::setFlagBright(bool b) {Nebula::flagBright = b;}
bool NebulaMgr::getFlagBright(void) const {return Nebula::flagBright;}
void NebulaMgr::setFlagShowNebula(bool b) {Nebula::flagShow = b;}
