...
class Oculars : public StelModule
{
	...
	Q_PROPERTY(bool flagShowCCDCenter		READ getFlagShowCCDCenter		WRITE setFlagShowCCDCenter		NOTIFY flagShowCCDCenterChanged)
...
public slots:
	...
	void setFlagShowCCDCenter(const bool b);
	bool getFlagShowCCDCenter(void) const;
...
signals:
	...
	void flagShowCCDCenterChanged(bool value);
...
private:
	...
	bool flagShowCCDCenter;			//!< Flag used to track if the marker of CCD's center (a X-char) should be shown.
