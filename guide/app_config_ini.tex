...
flag\_surface\_brightness\_arcsec  & bool & false &Toggle usage the measure unit $^m/_\square{'}$ ($^m/arcmin^2$) or $^m/_\square{''}$ ($^m/arcsec^2$) for the surface brightness of deep-sky objects.\\\midrule
