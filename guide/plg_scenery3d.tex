...
You activate the plugin with the \emph{circular enclosure} button \guibutton{0.6}{bt_scenery3d_off} at screen
bottom or by pressing \key{\ctrl+W}. The other button with circular enclosure and
tool icon  \guibutton{0.6}{bt_scenery3d_settings_off} (or \key{\ctrl+\shift+W}) opens the settings dialog. Once loaded and
...
850.000 triangles are working nicely with shadows and bumpmaps.  On very small
...
\guibutton{0.6}{bt_scenery3d_eyepoint_off} button. See the provided
...
Let us add a quick example here. A recent paper~\cite{Pollard:2017:UffingtonHorse} claims that the Uffington White Horse, 
...
First, locate the site in \program{Google Earth} at $\lambda=-1.56718, \phi=51.582843$. (Or just search for ``Uffington''.)
...
Open \program{Sketchup}, select the meter-based ``Landscape Architecture'' template, add \menu{View>Toolbars\ldots}, add Locations. 
...
speed~\cite{Zotti-Neubauer:VSMM2012,Zotti-Neubauer:EuroMed2012,Zotti:2012:SpringerAA}.
...
supervised by Michael Wimmer~\cite{Zotti:CHNT2015,Zotti:SEAC2015}. % TODO: add more (SEAC2016, SEAC2017) when they are published.
