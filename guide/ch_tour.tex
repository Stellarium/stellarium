...
Constellation Boundaries & \guibutton[0.75]{2.5}{bt_constellation_boundaries}& \key{B} & Draw boundary of the constellations \\
...
Galactic Grid            & \guibutton[0.75]{2.5}{bt_gal_grid}           &  & Draw grid lines for the galactic coordinate system (Long/Lat) \\
Equatorial J2000 Grid          & \guibutton[0.75]{2.5}{bt_eq_j2000_grid}           &  & Draw grid lines for the equatorial coordinate system on standard epoch J2000.0 (RA/Dec) \\
Ecliptic Grid            & \guibutton[0.75]{2.5}{bt_ecl_grid}           &  & Draw grid lines for the ecliptic coordinate system (Long/Lat) \\
