...
\begin{enumerate}
    ...
    \item \textbf{Add Texture to Storage}: Click \button{Add the Texture to Custom Storage} to permanently save the texture. The original image will be copied to Stellarium's plugin folder in the user directory. After adding a texture, you should restart Stellarium to fully integrate the texture into the module.
