...
public:
	...
	virtual QString getType() const override {return NEBULA_TYPE;}
	...
	virtual QString getID() const override {return getDSODesignation(); } //this depends on the currently shown catalog flags, should this be changed?
	virtual Vec3d getJ2000EquatorialPos(const StelCore* core) const override;
	virtual double getCloseViewFov(const StelCore* core = Q_NULLPTR) const override;
	...
	virtual Vec3f getInfoColor() const override;
	virtual QString getNameI18n() const override {return nameI18;}
	virtual QString getEnglishName() const override {return englishName;}
	QString getEnglishAliases() const;
	QString getI18nAliases() const;
	virtual double getAngularRadius(const StelCore*) const override;
	virtual SphericalRegionP getRegion() const override {return pointRegion;}
