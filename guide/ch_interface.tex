...
\item[Scale] will increase the apparent size of the selected class of objects:
  ...
  \end{description}
\item[Show minor body markers]\newFeature{24.3} Show a little circle at the location of every minor body (comet,
  ...
  From the ``Observer'' viewpoints, the visual magnitude is computed as seen from the Sun,
