...
*/
	...
	// 1. Location
	s_tui::Decimal_item* tui_location_latitude = new s_tui::Decimal_item(-90., 90., 0., "1.1 Latitude: ");
	s_tui::Decimal_item* tui_location_longitude = new s_tui::Decimal_item(-180., 180., 0., "1.2 Longitude: ");
	s_tui::Decimal_item* tui_location_altitude = new s_tui::Decimal_item(-500., 10000., 0, "1.3 Altitude: ");
	...
	// 2. Time
	s_tui::Action_item* tui_time_settmz = new s_tui::Action_item("2.1 Set Time Zone: ");
	s_tui::Time_item* tui_time_skytime = new s_tui::Time_item("2.2 Sky Time: ");
	s_tui::Time_item* tui_time_presetskytime = new s_tui::Time_item("2.3 Preset Sky Time: ");
	s_tui::Action_item* tui_time_actual = new s_tui::Action_item("2.4 Set Time to actual: ");
	s_tui::Boolean_item* tui_time_startuptime = new s_tui::Boolean_item(false, "2.5 Sky Time At Start-up: ", "Actual","Preset");
	s_tui::Boolean_item* tui_time_displayformat = new s_tui::Boolean_item(false, "2.6 Time Display Format: ", "12h","24h");
	...
	// 3. Constellations
	s_tui::Boolean_item* tui_constellation_lines = new s_tui::Boolean_item(false, "3.2 Lines: ", "Yes","No");
	s_tui::Boolean_item* tui_constellation_art = new s_tui::Boolean_item(false, "3.3 Art: ", "Yes","No");
	tui_menu_constellation->addComponent(tui_constellation_lines);
	tui_menu_constellation->addComponent(tui_constellation_art);

	// 4. Stars
	s_tui::Boolean_item* tui_stars_show = new s_tui::Boolean_item(false, "4.1 Show: ", "Yes","No");
	s_tui::Decimal_item* tui_star_labelmaxmag = new s_tui::Decimal_item(-1.5, 10., 2, "4.2 Maximum Magnitude to Label: ");
	s_tui::Boolean_item* tui_stars_twinkle = new s_tui::Boolean_item(false, "4.3 Twinkle: ", "Yes","No");
	...
	// 5. Labels
	s_tui::Boolean_item* tui_label_stars = new s_tui::Boolean_item(false, "5.1 Stars: ", "Yes","No");
	s_tui::Boolean_item* tui_label_constellations = new s_tui::Boolean_item(false, "5.2 Constellations: ", "Yes","No");
	s_tui::Boolean_item* tui_label_nebulas = new s_tui::Boolean_item(false, "5.3 Nebulas: ", "Yes","No");
	s_tui::Boolean_item* tui_label_planets = new s_tui::Boolean_item(false, "5.4 Planets: ", "Yes","No");
	s_tui::Boolean_item* tui_label_timeinfo = new s_tui::Boolean_item(false, "5.5 Time & Object Info: ", "Yes","No");
	...
	// 6. Reference Points
	s_tui::Boolean_item* tui_refpoints_cardinalpoints = new s_tui::Boolean_item(false, "6.1 Cardinal Points: ", "Yes","No");
	s_tui::Boolean_item* tui_refpoints_ecliptic = new s_tui::Boolean_item(false, "6.2 Ecliptic: ", "Yes","No");
	s_tui::Boolean_item* tui_refpoints_equator = new s_tui::Boolean_item(false, "6.3 Equator: ", "Yes","No");
	s_tui::Boolean_item* tui_refpoints_equatorialgrid = new s_tui::Boolean_item(false, "6.4 Equatorial Grid: ", "Yes","No");
	s_tui::Boolean_item* tui_refpoints_azimutalgrid = new s_tui::Boolean_item(false, "6.5 Azimutal Grid: ", "Yes","No");
	...
	// 7. Effects
	s_tui::Boolean_item* tui_effect_atmosphere = new s_tui::Boolean_item(false, "7.2 Atmopshere: ", "Yes","No");
	tui_menu_effects->addComponent(tui_effect_atmosphere);

	// 8. Administration
	s_tui::ActionConfirm_item* tui_admin_loaddefault = new s_tui::ActionConfirm_item("8.1 Load Default Configuration: ");
	s_tui::ActionConfirm_item* tui_admin_savedefault = new s_tui::ActionConfirm_item("8.2 Save Current Configuration as Default: ");
	s_tui::Action_item* tui_admin_setlocal = new s_tui::Action_item("8.3 WSet Locale: ");
	s_tui::Action_item* tui_admin_updateme = new s_tui::Action_item("8.4 Update me via Internet: ");
