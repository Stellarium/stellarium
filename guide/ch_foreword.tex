...
and surely all of us not familiar with the story will miss a lot, the figures alone, together with the standard names available in the ``Byname'' labels, 
may be a fresh view to the old figures. 


%A new plugin is out of its testing phase: SkyCulture Maker (SCM),
%thanks to a student team around our skyculture researcher, Susanne M. Hoffmann. 
%This guides you through creation of a skyculture to make sure no parts are omitted, and the files have the right structure. 
%You will see a few fine new skycultures already created with it.
...
And: If you are expert in the field of accessibility and want to redesign and extend this to become fully functional, we welcome your improvements!

You may also see this User Guide has fewer pages than the last. we have slightly redesigned the appearance and reduced font size, the actual content has again grown. 
