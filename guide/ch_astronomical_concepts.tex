...
(section~\ref{sec:Concepts:Parallax}). Precession causes a slow drift of the coordinates almost parallel to the \indexterm{ecliptic}, and therefore star catalogues always have to specify their \indexterm{equinox} of
validity.
...
Astronomical almanachs and observing guides often list \emph{transit
...
\item Proper motion is only modelled by linear components. True 3D
