...
check\_loading\_constellation\_data & bool & Set to \emph{true} to check loading constellation data.
                                      This option needed to debug new skycultures. Default value: \emph{false}.
convert\_locations\_list     & bool & Set to \emph{true} to convert file \file{base_locations.txt} 
                                      into file \file{base_kications.bin}\footnote{To get the standard 
                                      packed base_locations.bin.gz file please run \emph{gzip -nc 
                                      base_locations.bin > base_locations.bin.gz} command also.}. 
