...
\label{sec:landscapes:Polygonal:Artificial}
...
See section~\ref{sec:landscapes:Artificial} for more options.
...
\begin{figure}[p]
  \centering
  \includegraphics[width=9cm]{Rodeon_vr_head_01.jpg}
...
You do not have to visit a site to create a panorama from your own photographs. There is dedicated software that can process free and proprietary geodata.

A classic for archaeoastronomers is Andrew Smith's \program{Horizon}\footnote{url{http://www.agksmith.net/horizon/}} which can process SRTM 1'' data which are freely available.

A web service similar to HeyWhatsThat (see~\ref{sec:landscapes:Polygonal:Artificial}), 
\program{PeakFinder}\footnote{\url{https://www.peakfinder.com}}, 
creates a polygonal line and black/white landscape feature renderings and also allows downloading the horizon as installable landscape for Stellarium. 
A great feature of this service is the excellent gazetteer (peak identification) also visible on the website.

\name[Brian]{Doyle} has created another online service, \program{Skyliner}\footnote{\url{https://archaeoastronomyireland.github.io/skyliner/}}, 
computing a panorama in the web browser. A gazetteer can be created manually. 
A similar website that can also export Stellarium landscapes is \name[David]{Hoyle}'s \program{Panorama}\footnote{\url{https://www.standingstones.org/viewer.html}}. 
He also released his program, which can process SRTM and even Lidar data on Github\footnote{\url{https://github.com/davidjhoyle/OpenPanorama}}.



I have created a
website\footnote{\url{https://gzotti.github.io/panoCam.html}} where
