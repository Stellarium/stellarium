...
flag\_show\_nebulae\_ \mbox{background\_button} & bool & false & Set to \emph{true} if you want to have access to the 
                                                         button for enabling/disabling backgrounds for deep-sky objects\\\midrule
flag\_show\_toast\_survey\_button & bool & false & Set to \emph{true} if you want to have access to the button for 
                                                   enabling/disabling Digitized Sky Survey for deep-sky objects\\\midrule
...
cardinal_font\_size           & int  & Font size for cardinal points. Typical value: \emph{24}\\%\midrule
subcardinal_font\_size        & int  & Font size for subcardinal points. Typical value: \emph{18}\\%\midrule
