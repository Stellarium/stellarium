...
On some Intel UHD\newFeature{1.0} users may see the screen blanking when Stellarium is working --- the startup of planetarium with \textbf{--single-buffer} parameter can help here.
