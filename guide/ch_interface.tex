...
\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_main_tab}
...
\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_info_tab}
...
\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_navigation_tab}
...
\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_tools_tab}
\caption{Configuration Window: Tools Tab}
\label{fig:gui:configuration:tools}
\end{figure}

\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_scripts_tab}
\caption{Configuration Window: Scripts Tab}
\label{fig:gui:configuration:scripts}
\end{figure}

\begin{figure}[p]
\centering\includegraphics[scale=0.55]{config_dialog_plugins_tab}
...
\begin{figure}[t]
\includegraphics[width=\textwidth,trim=0 100 0 0,clip]{DSO_GUI}
...
\item[Projection] Selecting items in this list changes the
  ...
  \item[Miller Cylindrical] The Miller cylindrical projection is a
    modified Mercator projection, proposed by Osborn Maitland Miller
...
Some cultures have constellation art (e.g., Western and Inuit), and the rest
do not. Configurable options include
\begin{description}
...
\begin{figure}[p]
\centering\includegraphics[scale=0.7]{search_dialog}
\caption{The Search Window: Objects}
\label{fig:gui:search}
\end{figure}

\begin{figure}[p]
\centering\includegraphics[scale=0.7]{search_dialog_position}
\caption{The Search Window: Positions}
\label{fig:gui:search:position}
\end{figure}

\begin{figure}[p]
\centering\includegraphics[scale=0.7]{search_dialog_list}
...
\begin{figure}[p]
\centering\includegraphics[scale=0.7]{search_dialog_option}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\textwidth]{gui_AstroCalc}
...
The list is updated in regular intervals. % NOT YET, BUT WOULD BE HELPFUL:
% When date or time is changed on the date window, update follows immediately.
\item[Ephemeris] Select an object and start and end time, and compute
  ...
  focus.
% NOT YET, BUT WOULD BE HIGHLY WELCOME:
% You can export the list. %% TBD: can it be done? Qt file dialog, or script standard file  output.txt?
\item[Phenomena] Compute phenomena like conjunctions and oppositions
  between planetary objects.
% TBD: Opp/Conj with sun is not yet available? 
\end{description}
...
\begin{figure}[htbp]
\centering\includegraphics[scale=0.6]{help_dialog}
\caption{Help Window}
\label{fig:gui:help}
\end{figure}
...
\begin{figure}[htbp]
\centering\includegraphics[scale=0.6]{help_dialog_about}
...
\begin{figure}[htbp]
\centering\includegraphics[scale=0.6]{help_dialog_log}
