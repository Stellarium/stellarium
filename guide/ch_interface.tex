...
\begin{description}
\item[Details and Appearance] provides textual information about the currently selected skyculture, 
and user interface elements to fine-tune the display of available data.
\item[Exploration and Selection] provides a list of available skycultures, sorted into blocks of geographic regions, 
