...
The Mosaic Camera plugin enables a user to overlay an outline of a mosaic camera, i.e., one with multiple sensors, onto the Stellarium celestial sphere.
...
\subsection{Default Cameras}
\subsection{Adding a Camera}
