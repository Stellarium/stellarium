...
void FOVWindow::setAboutHtml()
{
	...
	// TRANSLATORS: The text between braces is the text of an HTML link.
	html += "<li>" + q_("If you want to read full information about this plugin and its history, you can {get info here}.").toHtmlEscaped().replace(a_rx, "<a href=\"http://stellarium.sourceforge.net/wiki/index.php/Field_of_View_plugin\">\\1</a>") + "</li>";
	html += "</ul></p></body></html>";
