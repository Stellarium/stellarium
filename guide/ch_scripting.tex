...
% Give current version in production PDFs, and at least some valid version in betas.
\ifthenelse{\equal{\StelVersion}{0.90.0}}%
	{\url{http://www.stellarium.org/doc/0.16.0/scripting.html}}%
