...
\item[Teresa Huertas Roldán] Planet nomenclature 
\end{description}
...
accurate) and outreach (making it usable for museum installations), 
but also on graphic items like comet tails or the Zodiacal Light.
...
%\item[2017-12] v0.17.0: Nomenclature labels for planets and moons
\end{description}
...
references to previous versions may still be made for completeness, 
