...
void Satellites::init()
{
	...
	try
	{
		...
		addAction("actionShow_Satellite_Hints", "Satellites", N_("Satellite hints"), "Ctrl+Z", "hintsVisible");
		addAction("actionShow_Satellite_Labels", "Satellites", N_("Satellite labels"), "Shift+Z", "labelsVisible");
		addAction("actionShow_Satellite_ConfigDialog_Global", "Satellites", N_("Satellites configuration window"), "Alt+Z", configDialog, "visible");
