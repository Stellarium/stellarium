...
optional extensions called plug-ins which are presented in the following chapters.
%: Angle Measure, Compass Marks, Oculars, Telescope Control, Text
...
%RemoteControl, Navigation Stars and RemoteSync. 
All these plug-ins are ``built-in'' in the standard Stellarium distribution
...
plugin's configuration dialog \newFeature{0.21.2} is also available by
