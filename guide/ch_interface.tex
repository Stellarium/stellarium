...
\begin{figure}[htbp]
\centering\includegraphics[width=0.85\textwidth]{view_dialog_skyculture_tab.png}
...
to define unique short labels that help memorizing. Some skycultures still just show numbers.
...
the \guibutton[0.6]{0.1}{uibtSettings.png}~\emph{Custom interval} window is enabled, and a preset solar altitude can be selected 
